...
humanoid-profile-editor-traits-points = Очки: { $current } / { $max }
traits-category-default = Общие
humanoid-profile-editor-traits-header = { $points }
humanoid-profile-editor-traits-no-points = Недостаточно очков для сохранения!
