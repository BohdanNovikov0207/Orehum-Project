...
station-goal-bluespace-harvest =
    { station-goal-start }[bold]
    Второстепенная цель — создание и тестирование на перегрузку экспериментального блюспейс-добытчика.[/bold]
...
# Orehum goals
station-goal-cleaning-space =
    { station-goal-start }[bold]
    Второстепенная цель — Полная санитарная очистка сектора.[/bold]

    Для поддержания высокого стандарта безопасности движения флота Nanotrasen и обеспечения бесперебойной работы радарного кольца,
    станции предписано провести плановую дефрагментацию окружающего пространства.
    Очистить локальный сектор от скоплений навигационного мусора:
    дрейфующих обломков конструкций, техногенных остатков и мелких астероидов, мешающих чистоте радиоэфира.
...
station-goal-bluespace-artillery =
    ...
    Отделу исследований и разработки необходимо открыть технологию "Блюспейс" и "Блюспейс артиллерия", построить блюспейс артиллерия,
