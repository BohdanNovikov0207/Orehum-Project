...
# Orehum
gs-balanceui-shop-buy-token-antag = Купить токен антагониста - { $price } Орешков
gs-balanceui-shop-buy-token-revival = Купить токен на перерождение - { $price } Орешков
gs-balanceui-shop-buy-token-accessory = Купить токен на аксессуар - { $price } Орешков
gs-balanceui-shop-buy-token-scenario = Купить токен сценария - { $price } Орешков
gs-balanceui-shop-token-antag = Токен антагониста
gs-balanceui-shop-token-revival = Токен милости
gs-balanceui-shop-token-accessory = Токен аксессуара
gs-balanceui-shop-token-scenario = Токен сценария
gs-balanceui-shop-buy-token-antag-desc = Позволяет стать любым антагонистом в игре в том случае, если на станции присутствует хотя бы 2 сотрудника СБ. Можно использовать только один раз в день.
gs-balanceui-shop-buy-token-revival-desc = Позволяет переродится. Вы будете отправлены в лобби и сможете вернуться в раунд за другого [!] персонажа. Важно: вы не можете переродится, если вы были антагонистом в этом раунде.
gs-balanceui-shop-buy-token-accessory-desc = Позволяет вам получить любой предмет аксессуара, который незначительно либо вовсе не влияет на геймплей.
gs-balanceui-shop-buy-token-scenario-desc = Позволяет вам получить личную сюжетную линию/проблему/сценарий, который будет касаться вашего персонажа и требует вмешательства администрации. Важно: использование возможно только, если на сервере присутствует Гейм-мастер.
...
gs-balanceui-remark-token-antag = Куплен токен антагониста.
gs-balanceui-remark-token-revival = Куплен токен перерождения.
gs-balanceui-remark-token-accessory = Куплен токен аксессуара.
gs-balanceui-remark-token-scenario = Куплен токен RP сценария.
