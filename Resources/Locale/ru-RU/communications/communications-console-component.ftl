...
comms-console-station-announcements-header = Станционные объявления
comms-console-station-broadcast-header = Станционное транслирование
comms-console-announce-tab-title = Рация
comms-console-broadcast-tab-title = Экран
comms-console-message-cannot-send = Телекоммуникации временно отключены
...
comms-console-level-green-flavour-label = Выполняйте свою работу
comms-console-level-blue-flavour-label = Сообщайте о подозрительной активности
comms-console-level-violet-flavour-label = Соблюдайте социальную дистанцию
comms-console-level-yellow-flavour-label = Будьте готовы задерживать дыхание
...
comms-console-level-white-flavour-label = Ликвидируйте псиоников
comms-console-level-enigma-flavour-label = Эвакуируйтесь
comms-console-level-omicron-flavour-label = Следуйте указаниям Центкома