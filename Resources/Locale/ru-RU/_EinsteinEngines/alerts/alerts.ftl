...
alerts-low-plasma-desc = В воздухе, котором вы дышите [color=red]недостаточно плазмы[/color]. Наденьте [color=green]газовый баллон с плазмой[/color].

alerts-high-oxygen-name = [color=red]Много кислорода[/color]
alerts-high-oxygen-desc = В воздухе, котором вы дышите [color=red]слишком много кислорода[/color]. Наденьте [color=green]газовый баллон с плазмой[/color].
