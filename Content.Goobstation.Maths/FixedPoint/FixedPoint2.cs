...
public struct FixedPoint2 : ISelfSerialize, IComparable<FixedPoint2>, IEquatable<FixedPoint2>, IFormattable
{
    ...
    public static FixedPoint2 New(int value) => new(value * ShiftConstant);

    public static FixedPoint2 FromCents(int value) => new(value);

    public static FixedPoint2 FromHundredths(int value) => new(value);

    public static FixedPoint2 New(float value) => new((int) ApplyFloatEpsilon(value * ShiftConstant));
    ...
    /// </summary>
    public static FixedPoint2 NewCeiling(float value) => new((int) MathF.Ceiling(value * ShiftConstant));

    public static FixedPoint2 New(double value) => new((int) ApplyFloatEpsilon(value * ShiftConstant));

    public static FixedPoint2 New(string value) => New(Parse.Float(value));
    ...
    public static FixedPoint2 operator *(FixedPoint2 a, FixedPoint2 b) => new(b.Value * a.Value / ShiftConstant);

    public static FixedPoint2 operator *(FixedPoint2 a, float b) => new((int) ApplyFloatEpsilon(a.Value * b));

    public static FixedPoint2 operator *(FixedPoint2 a, double b) => new((int) ApplyFloatEpsilon(a.Value * b));

    public static FixedPoint2 operator *(FixedPoint2 a, int b) => new(a.Value * b);

    public static FixedPoint2 operator /(FixedPoint2 a, FixedPoint2 b) =>
        new((int) (ShiftConstant * (long) a.Value / b.Value));

    public static FixedPoint2 operator /(FixedPoint2 a, float b) => new((int) ApplyFloatEpsilon(a.Value / b));

    public static bool operator <=(FixedPoint2 a, int b) => a <= New(b);
    ...
    public readonly int Int() => Value / ShiftConstant;
    ...
    public static FixedPoint2 Min(params FixedPoint2[] fixedPoints) => fixedPoints.Min();

    public static FixedPoint2 Min(FixedPoint2 a, FixedPoint2 b) => a < b ? a : b;

    public static FixedPoint2 Max(FixedPoint2 a, FixedPoint2 b) => a > b ? a : b;
    ...
    public static FixedPoint2 Abs(FixedPoint2 a) => FromCents(Math.Abs(a.Value));

    public static FixedPoint2 Dist(FixedPoint2 a, FixedPoint2 b) => Abs(a - b);
    ...
    public readonly bool Equals(FixedPoint2 other) => Value == other.Value;
