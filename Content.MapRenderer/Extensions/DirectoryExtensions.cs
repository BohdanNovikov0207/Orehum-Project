...
public static class DirectoryExtensions
{
    ...
    public static DirectoryInfo Resources() => new($"{RepositoryRoot()}{Path.DirectorySeparatorChar}Resources");

    public static DirectoryInfo Maps() => new($"{Resources()}{Path.DirectorySeparatorChar}Maps");

    public static DirectoryInfo MapImages() => new($"{Resources()}{Path.DirectorySeparatorChar}MapImages");
}
