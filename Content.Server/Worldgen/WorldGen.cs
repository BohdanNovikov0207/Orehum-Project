...
public static class WorldGen
{
    ...
    public static Vector2i WorldToChunkCoords(Vector2i inp) =>
        (inp * new Vector2(1.0f / ChunkSize, 1.0f / ChunkSize)).Floored();
    ...
    /// <returns>Chunk coordinates</returns>
    [Pure]
    public static Vector2 WorldToChunkCoords(Vector2 inp) => inp * new Vector2(1.0f / ChunkSize, 1.0f / ChunkSize);
    ...
    [Pure]
    public static Vector2 ChunkToWorldCoords(Vector2i inp) => inp * ChunkSize;
    ...
    /// <returns>World coordinates</returns>
    [Pure]
    public static Vector2 ChunkToWorldCoords(Vector2 inp) => inp * ChunkSize;
    ...
    /// <returns>World coordinates</returns>
    [Pure]
    public static Vector2 ChunkToWorldCoordsCentered(Vector2i inp) => inp * ChunkSize + Vector2i.One * (ChunkSize / 2);
}
