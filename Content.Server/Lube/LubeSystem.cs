...
public sealed class LubeSystem : EntitySystem
{
    ...
    private bool TryLube(Entity<LubeComponent> entity, EntityUid target, EntityUid actor)
    {
        ...
        {
            _popup.PopupEntity(Loc.GetString("lube-failure", ("target", Identity.Entity(target, EntityManager))),
                actor,
                actor,
                PopupType.Medium);
            return false;
            ...
            _solutionContainer.TryGetSolution(entity.Owner, entity.Comp.Solution, out _, out var solution))
        {
            ...
            if (quantity > 0)
            {
                ...
                lubed.SlipsLeft = _random.Next(entity.Comp.MinSlips * quantity.Int(),
                ...
                _popup.PopupEntity(Loc.GetString("lube-success", ("target", Identity.Entity(target, EntityManager))),
                    actor,
                    actor,
                    PopupType.Medium);
                return true;
