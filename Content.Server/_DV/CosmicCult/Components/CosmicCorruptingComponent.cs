...
public sealed partial class CosmicCorruptingComponent : Component
{
    ...
    /// <summary>
    /// Wether or not the CosmicCorruptingSystem should be running on this entity. use CosmicCorruptingSystem.Enable() instead
    /// of directly interacting with this variable.
    /// </summary>
    [DataField]
    ...
    /// <summary>
    /// if this corruption source should floodfill through all corruptible tiles to initialise its corruptible tile set on
    /// activation.
    /// </summary>
    [DataField]
