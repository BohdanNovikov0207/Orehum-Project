...
public sealed class HarpySingerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<HarpySingerComponent, OpenUiActionEvent>(OnInstrumentOpen,
    ...
    private void OnZombified(ref EntityZombifiedEvent args) => CloseMidiUi(args.Target);

    private void OnStunned(EntityUid uid, InstrumentComponent component, ref StunnedEvent args) => CloseMidiUi(uid);
    ...
    /// </summary>
    private void OnBeforeDamageChanged(EntityUid uid,
        HarpySingerComponent harpySingerComponent,
        BeforeDamageChangedEvent args)
    {
    ...
    private void OnInstrumentOpen(EntityUid uid, HarpySingerComponent component, OpenUiActionEvent args)
    {
        ...
        var zombified = TryComp<ZombieComponent>(uid, out _);
