    ...
    private void AddTricksVerbs(GetVerbsEvent<Verb> args)
    {
        ...
        if (TryComp<AirlockComponent>(args.Target, out var airlockComp))
        {
            Verb emergencyAccess = new()
            {
                ...
                Category = VerbCategory.Tricks,
                Icon =
                    new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/emergency_access.png")),
                Act = () =>
                {
                ...
                Priority = (int) (airlockComp.EmergencyAccess
        ...
        if (TryComp<BatteryComponent>(args.Target, out var battery))
        {
            Verb refillBattery = new()
            {
                Text = "Refill Battery",
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/fill_battery.png")),
                Act = () =>
                {
            ...
            Verb drainBattery = new()
            {
                Text = "Drain Battery",
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/drain_battery.png")),
                Act = () =>
                {
            ...
            Verb infiniteBattery = new()
            {
                ...
                Category = VerbCategory.Tricks,
                Icon =
                    new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/infinite_battery.png")),
                Act = () =>
                {
        ...
        if (activeId is not null)
        {
            Verb grantAllAccess = new()
            {
                ...
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/Objects/Misc/id_cards.rsi"), "centcom"),
                Act = () =>
                {
            ...
            Verb revokeAllAccess = new()
            {
                ...
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/Objects/Misc/id_cards.rsi"), "default"),
                Act = () =>
                {
        ...
        if (TryComp<StackComponent>(args.Target, out var stack))
        {
            Verb adjustStack = new()
            {
                Text = "Adjust Stack",
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/adjust-stack.png")),
                Act = () =>
                {
            ...
            Verb fillStack = new()
            {
                Text = "Fill Stack",
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/fill-stack.png")),
                Act = () =>
                {
        ...
        Verb rename = new()
        {
            Text = "Rename",
            Category = VerbCategory.Tricks,
            Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/rename.png")),
            Act = () =>
            {
                _quickDialog.OpenDialog(player,
                    "Rename",
        ...
        Verb redescribe = new()
        {
            Text = "Redescribe",
            Category = VerbCategory.Tricks,
            Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/redescribe.png")),
            Act = () =>
            {
                _quickDialog.OpenDialog(player,
                    "Redescribe",
        ...
        Verb renameAndRedescribe = new()
        {
            ...
            Icon = new SpriteSpecifier.Texture(
                new ResPath("/Textures/Interface/AdminActions/rename_and_redescribe.png")),
            Act = () =>
            {
                _quickDialog.OpenDialog(player,
                    "Rename & Redescribe",
        ...
        if (TryComp<StationDataComponent>(args.Target, out var stationData))
        {
            if (_adminManager.HasAdminFlag(player, AdminFlags.Round))
            {
                Verb barJobSlots = new()
                {
                    ...
                    Category = VerbCategory.Tricks,
                    Icon =
                        new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/bar_jobslots.png")),
                    Act = () =>
                    {
            ...
            Verb locateCargoShuttle = new()
            {
                ...
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/Clothing/Head/Soft/cargosoft.rsi"), "icon"),
                Act = () =>
                {
        ...
        if (TryComp<PhysicsComponent>(args.Target, out var physics))
        {
            Verb haltMovement = new()
            {
                Text = "Halt Movement",
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/halt.png")),
                Act = () =>
                {
        ...
        if (TryComp<JointComponent>(args.Target, out var joints))
        {
            Verb snapJoints = new()
            {
                Text = "Snap Joints",
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/AdminActions/snap_joints.png")),
                Act = () =>
                {
        ...
        if (TryComp<GunComponent>(args.Target, out var gun))
        {
            Verb minigunFire = new()
            {
                Text = "Make Minigun",
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/Objects/Weapons/Guns/HMGs/minigun.rsi"), "icon"),
                Act = () =>
                {
        ...
        if (TryComp<BallisticAmmoProviderComponent>(args.Target, out var ballisticAmmo))
        {
            Verb setCapacity = new()
            {
                ...
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/Objects/Fun/caps.rsi"), "mag-6"),
                Act = () =>
                {
                    _quickDialog.OpenDialog(player,
                        "Set Bullet Amount",
