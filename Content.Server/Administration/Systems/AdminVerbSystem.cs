...
public sealed partial class AdminVerbSystem : EntitySystem
{
    ...
    private void AddAdminVerbs(GetVerbsEvent<Verb> args)
    {
        ...
        if (_adminManager.IsAdmin(player))
        {
            ...
            if (TryComp(args.Target, out ActorComponent? targetActor))
            {
                ...
                verb.Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/gavel.svg.192dpi.png"));
                verb.Act = () =>
                ...
                prayerVerb.Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/pray.svg.png"));
                prayerVerb.Act = () =>
                {
                    _quickDialog.OpenDialog(player,
                        ...
                        {
                            _prayerSystem.SendSubtleMessage(targetActor.PlayerSession,
                                player,
                                message,
            ...
            if (!frozen)
            {
                args.Verbs.Add(new Verb
                {
                    ...
                    Category = VerbCategory.Admin,
                    Icon =
                        new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/VerbIcons/snow.svg.192dpi.png")),
                    Act = () =>
                    {
            ...
            if (_adminManager.HasAdminFlag(player, AdminFlags.Logs))
            {
                Verb logsVerbEntity = new()
                {
                    ...
                    Act = () =>
                    {
                        ...
                        ui.SetLogFilter(args.Target.Id.ToString());
                    },
                    Impact = LogImpact.Low,
                };
                ...
                Act = () =>
                {
                    if (HasComp<MapGridComponent>(args.Target))
                    {
                        if (player.AttachedEntity != null)
                        {
                            ...
                            _console.ExecuteCommand(player,
            ...
            if (lawBoundComponent != null && target != null && _adminManager.HasAdminFlag(player, AdminFlags.Moderator))
            {
                args.Verbs.Add(new Verb
                {
                    ...
                    Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/Interface/Actions/actions_borg.rsi"),
                        "state-laws"),
                });
            }
    ...
    private void AddDebugVerbs(GetVerbsEvent<Verb> args)
    {
        ...
        // Delete verb
        if (_toolshed.ActivePermissionController?.CheckInvokable(
    ...
    private void OnSolutionChanged(Entity<SolutionContainerManagerComponent> entity,
