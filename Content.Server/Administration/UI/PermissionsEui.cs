...
public sealed class PermissionsEui : BaseEui
{
    ...
    public override EuiStateBase GetNewState()
    {
        ...
        return new PermissionsEuiState
        {
            ...
            AdminRanks = _adminRanks.ToDictionary(a => a.Id,
    ...
    private static List<AdminRankFlag> GenRankFlagList(AdminFlags flags) => AdminFlagsHelper.FlagsToNames(flags)
        .Select(f => new AdminRankFlag { Flag = f })
        .ToList();

    private bool UserAdminFlagCheck(AdminFlags flags) => _adminManager.HasAdminFlag(Player, flags);
