...
public partial interface IGhostRoleRaffleDecider
{
    ...
    /// <ul>
    ///     <li>
    ///     If <c>true</c> is returned, your winner was able to take over the ghost role, and the drawing is complete.
    ///     <b>Do not call <see cref="tryTakeover" /> again after true is returned.</b>
    ///     </li>
    ///     <li>
    ///     If <c>false</c> is returned, your winner was not able to take over the ghost role,
    ///     and you must choose another winner, and call <see cref="tryTakeover" /> with the new winner as argument.
    ///     </li>
    /// </ul>
