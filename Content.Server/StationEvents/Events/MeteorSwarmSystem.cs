...
public sealed class MeteorSwarmSystem : GameRuleSystem<MeteorSwarmComponent>
{
        ...
        GameRuleAddedEvent args)
    {
        ...
        if (component.Announcement is { } locId)
            _chat.DispatchFilteredAnnouncement(allPlayersInGame,
                Loc.GetString(locId),
                playSound: false,
        ...
        float frameTime)
    {
        ...
        for (var i = 0; i < meteorsToSpawn; i++)
        {
            ...
            var offset =
                angle.RotateVec(new Vector2((maximumDistance - minimumDistance) * RobustRandom.NextFloat() +
                                            minimumDistance,
                    0));
            ...
            _physics.ApplyLinearImpulse(meteor,
