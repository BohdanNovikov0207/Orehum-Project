...
public sealed class KitchenSpikeSystem : SharedKitchenSpikeSystem
{
    ...
    private void Spike(EntityUid uid,
        EntityUid userUid,
        EntityUid victimUid,
    ...
    private bool TryGetPiece(EntityUid uid,
        EntityUid user,
        EntityUid used,
        KitchenSpikeComponent? component = null,
        SharpComponent? sharp = null)
    {
        if (!Resolve(uid, ref component) || component.PrototypesToSpawn == null ||
    ...
    private bool Spikeable(EntityUid uid,
        EntityUid userUid,
        EntityUid victimUid,
        KitchenSpikeComponent? component = null,
        ButcherableComponent? butcherable = null)
    {
        ...
        {
            _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-deny-butcher",
                    ("victim", Identity.Entity(victimUid, EntityManager)),
                    ("this", uid)),
                victimUid,
                userUid);
        ...
        {
            _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-deny-changeling",
                    ("victim", Identity.Entity(victimUid, EntityManager)),
                    ("this", uid)),
                victimUid,
                userUid);
        ...
        {
            _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-deny-absorbed",
                    ("victim", Identity.Entity(victimUid, EntityManager)),
                    ("this", uid)),
                victimUid,
                userUid);
        ...
        switch (butcherable.Type)
        {
            ...
            case ButcheringType.Knife:
                _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-deny-butcher-knife",
                        ("victim", Identity.Entity(victimUid, EntityManager)),
                        ("this", uid)),
                    victimUid,
                    userUid);
    ...
    public bool TrySpike(EntityUid uid,
        EntityUid userUid,
        EntityUid victimUid,
        KitchenSpikeComponent? component = null,
        ButcherableComponent? butcherable = null,
        MobStateComponent? mobState = null)
    {
        ...
        {
            _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-deny-not-dead",
                    ("victim", Identity.Entity(victimUid, EntityManager))),
                victimUid,
                userUid);
            return true;
        ...
        if (userUid != victimUid)
            _popupSystem.PopupEntity(
                Loc.GetString("comp-kitchen-spike-begin-hook-victim",
                    ("user", Identity.Entity(userUid, EntityManager)),
                    ("this", uid)),
                victimUid,
                victimUid,
