...
public sealed class TransformableContainerSystem : EntitySystem
{
    ...
    private void OnSolutionChange(Entity<TransformableContainerComponent> entity,
    ...
    private void OnRefreshNameModifiers(Entity<TransformableContainerComponent> entity,
        ref RefreshNameModifiersEvent args)
    {
        if (_prototypeManager.TryIndex(entity.Comp.CurrentReagent, out var currentReagent))
            args.AddModifier("transformable-container-component-glass", -1, ("reagent", currentReagent.LocalizedName));
    }
