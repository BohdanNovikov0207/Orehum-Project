...
public sealed class DeleteOnSolutionEmptySystem : EntitySystem
{
    ...
    public void OnSolutionChange(Entity<DeleteOnSolutionEmptyComponent> entity,
        ref SolutionContainerChangedEvent args) => CheckSolutions(entity);
    ...
    public void CheckSolutions(Entity<DeleteOnSolutionEmptyComponent> entity)
    {
        ...
        if (_solutionContainerSystem.TryGetSolution((entity.Owner, solutions),
