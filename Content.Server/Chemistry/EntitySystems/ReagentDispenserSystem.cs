...
public sealed class ReagentDispenserSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ReagentDispenserComponent, MapInitEvent>(OnMapInit, new[] { typeof(ItemSlotsSystem) });
    }

    private void SubscribeUpdateUiState<T>(Entity<ReagentDispenserComponent> ent, ref T ev) => UpdateUiState(ent);
    ...
    private void OnSetDispenseAmountMessage(Entity<ReagentDispenserComponent> reagentDispenser,
    ...
    private void OnDispenseReagentMessage(Entity<ReagentDispenserComponent> reagentDispenser,
    ...
    private void OnEjectReagentMessage(Entity<ReagentDispenserComponent> reagentDispenser,
        ref ReagentDispenserEjectContainerMessage message)
    {
        if (!TryComp<StorageComponent>(reagentDispenser.Owner, out var storage))
            return;
    ...
    private void OnClearContainerSolutionMessage(Entity<ReagentDispenserComponent> reagentDispenser,
