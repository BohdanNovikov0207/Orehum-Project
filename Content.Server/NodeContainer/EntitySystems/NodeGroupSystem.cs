...
public sealed class NodeGroupSystem : EntitySystem
{
    ...
    public void QueueNodeRemove(Node node) => _toRemove.Add(node);
    ...
    public void ForceUpdate() => DoGroupUpdates();
...
/// <summary>
/// Event raised after node groups have been updated. Directed at any entity with a
/// <see
///     cref="NodeContainerComponent" />
/// that had a relevant node.
/// </summary>
[ByRefEvent]
