...
public sealed class StackSystem : SharedStackSystem
{
    ...
    [Dependency]
    private readonly SharedUserInterfaceSystem _ui = default!; // Goobstation - Custom stack splitting dialog
    ...
    /// </summary>
    public override EntityUid? Split(EntityUid uid,
        int amount,
        EntityCoordinates spawnPosition,
        StackComponent? stack = null) // Goobstation - override virtual method
    {
    ...
    public void UserSplit(EntityUid uid,
        EntityUid userUid,
        int amount,
