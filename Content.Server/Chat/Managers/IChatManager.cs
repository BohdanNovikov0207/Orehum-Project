...
public interface IChatManager : ISharedChatManager
{
    ...
    void ChatMessageToOne(ChatChannel channel,
        string message,
        ...
        bool canCoalesce = true); // Goobstation Edit

    void ChatMessageToMany(ChatChannel channel,
        string message,
        string wrappedMessage,
        EntityUid source,
        bool hideChat,
    ...
    void ChatMessageToManyFiltered(Filter filter,
        ChatChannel channel,
        string message,
        string wrappedMessage,
        EntityUid source,
    ...
    void ChatMessageToAll(ChatChannel channel,
        string message,
        string wrappedMessage,
        EntityUid source,
        bool hideChat,
