...
internal sealed partial class ChatManager : IChatManager
{
    ...
    public void DispatchServerAnnouncement(string message, Color? colorOverride = null)
    {
        ...
        ChatMessageToAll(ChatChannel.Server, message, wrappedMessage, EntityUid.Invalid, false, true, colorOverride);
    ...
    public void SendHookOOC(string sender, string message)
    {
        ...
        var wrappedMessage = Loc.GetString("chat-manager-send-hook-ooc-wrap-message",
            ("senderName", sender),
            ("message", FormattedMessage.EscapeText(message)));
        ChatMessageToAll(ChatChannel.OOC, message, wrappedMessage, EntityUid.Invalid, false, true);
