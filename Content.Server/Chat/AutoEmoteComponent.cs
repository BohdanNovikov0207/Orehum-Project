...
public sealed partial class AutoEmoteComponent : Component
{
    ...
    /// <summary>
    [ViewVariables(VVAccess
        .ReadOnly)] //TODO: make this a datafield and (de)serialize values as time offsets when https://github.com/space-wizards/RobustToolbox/issues/3768 is fixed
    public Dictionary<string, TimeSpan> EmoteTimers = new();
