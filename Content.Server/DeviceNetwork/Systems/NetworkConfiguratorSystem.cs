...
public sealed class NetworkConfiguratorSystem : SharedNetworkConfiguratorSystem
{
    ...
    public override void Initialize()
    {
        ...
        //Interaction
        SubscribeLocalEvent<NetworkConfiguratorComponent, AfterInteractEvent>(
            AfterInteract); //TODO: Replace with utility verb?
        ...
        SubscribeLocalEvent<DeviceLinkSinkComponent, GetVerbsEvent<AlternativeVerb>>(
            OnAddAlternativeSaveDeviceVerbSink);
        SubscribeLocalEvent<DeviceLinkSourceComponent, GetVerbsEvent<AlternativeVerb>>(
            OnAddAlternativeSaveDeviceVerbSource);
        // </Goobstation>
    ...
    private void TryAddNetworkDevice(EntityUid? targetUid,
    ...
    private void TryAddNetworkDevice(EntityUid configuratorUid,
        EntityUid? targetUid,
        EntityUid userUid,
        ...
        DeviceNetworkComponent? device = null)
    {
        ...
        {
            _popupSystem.PopupCursor(Loc.GetString("network-configurator-device-already-saved", ("device", targetUid)),
                userUid);
            return;
        }
    ...
    private void TryLinkDevice(EntityUid uid,
        NetworkConfiguratorComponent configurator,
        EntityUid? target,
        EntityUid user)
    {
    ...
    private void TryLinkDefaults(EntityUid _,
        NetworkConfiguratorComponent configurator,
        EntityUid? targetUid,
        EntityUid user)
    {
    ...
    private bool AccessCheck(EntityUid target, EntityUid? user, NetworkConfiguratorComponent component)
    {
        ...
        _audioSystem.PlayPvs(component.SoundNoAccess,
            user.Value,
    ...
    /// </summary>
    /// >
    private void SetMode(EntityUid configuratorUid,
        NetworkConfiguratorComponent configurator,
        EntityUid userUid,
        bool linkMode)
    {
    ...
    /// </summary>
    private void UpdateModeAppearance(EntityUid userUid,
        EntityUid configuratorUid,
        NetworkConfiguratorComponent configurator)
    {
        ...
        _audioSystem.PlayPvs(configurator.SoundSwitchMode,
            userUid,
    ...
    /// </summary>
    private void OnUsed(EntityUid uid,
        NetworkConfiguratorComponent configurator,
        EntityUid? target,
        EntityUid user,
        bool canReach = true)
    ...
    private void DetermineMode(EntityUid configuratorUid,
        NetworkConfiguratorComponent configurator,
        EntityUid? target,
        EntityUid userUid)
    {
    ...
    /// </summary>
    private void OnAddInteractVerb(EntityUid uid,
        NetworkConfiguratorComponent configurator,
        GetVerbsEvent<UtilityVerb> args)
    {
        ...
        if (configurator.LinkModeActive && (HasComp<DeviceLinkSinkComponent>(args.Target) ||
        ...
        else if (HasComp<DeviceNetworkComponent>(args.Target))
        {
            ...
            verb.Text = Loc.GetString(isDeviceList
                ? "network-configurator-configure"
                : "network-configurator-save-device");
    ...
    /// Adds an alternative verb for saving a device on the configurator for entities with the
    /// <see cref="DeviceListComponent" />.
    ...
    /// </summary>
    private void OnAddAlternativeSaveDeviceVerb(EntityUid uid,
    ...
    // <Goobstation> - Fix device alt-verbs
    private void OnAddAlternativeSaveDeviceVerbSink(EntityUid uid,
        DeviceLinkSinkComponent component,
        GetVerbsEvent<AlternativeVerb> args) => AddAlternativeVerbs(uid, args);

    private void OnAddAlternativeSaveDeviceVerbSource(EntityUid uid,
    ...
    private void OnAddSwitchModeVerb(EntityUid uid,
        NetworkConfiguratorComponent configurator,
        GetVerbsEvent<AlternativeVerb> args)
    {
        if (!args.CanAccess || !args.CanInteract || !args.Using.HasValue ||
    ...
    private void OpenDeviceLinkUi(EntityUid configuratorUid,
        EntityUid? targetUid,
        EntityUid userUid,
        NetworkConfiguratorComponent configurator)
    {
        ...
        if (!targetUid.HasValue || !configurator.ActiveDeviceLink.HasValue ||
        ...
        if (TryComp(configurator.ActiveDeviceLink, out DeviceLinkSourceComponent? activeSource) &&
            TryComp(targetUid, out DeviceLinkSinkComponent? targetSink))
            UpdateLinkUiState(configuratorUid,
                configurator.ActiveDeviceLink.Value,
                targetUid.Value,
                activeSource,
                targetSink);
    ...
    private void UpdateLinkUiState(EntityUid configuratorUid,
        EntityUid sourceUid,
        EntityUid sinkUid,
    ...
    /// </summary>
    public void ClearActiveDeviceList(EntityUid configUid,
        NetworkConfiguratorComponent configComp,
        EntityUid? prevListUid = null,
        DeviceListComponent? prevListComp = null)
    {
    ...
    /// </summary>
    public void SetActiveDeviceList(EntityUid configUid,
        NetworkConfiguratorComponent configComp,
        EntityUid? nextListUid = null,
        DeviceListComponent? nextListComp = null)
    {
        // unset previous
    ...
    /// </summary>
    private void OpenDeviceListUi(EntityUid configuratorUid,
        EntityUid? targetUid,
        EntityUid userUid,
        NetworkConfiguratorComponent configurator)
    {
    ...
    /// </summary>
    private void OnRemoveDevice(EntityUid uid,
    ...
    /// </summary>
    private void OnClearDevice(EntityUid uid,
        NetworkConfiguratorComponent component,
    ...
    private void OnClearLinks(EntityUid uid,
        NetworkConfiguratorComponent configurator,
    ...
    private void OnToggleLinks(EntityUid uid,
        NetworkConfiguratorComponent configurator,
    ...
    /// </summary>
    private void OnSaveLinks(EntityUid uid,
        NetworkConfiguratorComponent configurator,
    ...
    /// </summary>
    private void OnConfigButtonPressed(EntityUid uid,
        NetworkConfiguratorComponent component,
        NetworkConfiguratorButtonPressedMessage args)
    {
        ...
        switch (args.ButtonKey)
        {
            case NetworkConfiguratorButtonKey.Set:
                ...
                result = _deviceListSystem.UpdateDeviceList(component.ActiveDeviceList.Value,
