...
/// <summary>
/// When applied to a humanoid or any mob with a FlightComponent (harpies mostly), adjusts their flight speed and stamina
/// drain based on their scale after entity initialization.
...
/// This is balanced to discourage disproportionate harpies. Flight is an EXTREMELY potent movement tool, and could become
/// incredibly frustrating
/// when combined with a small character (difficult to hit) or a large character (potent in combat).
/// Small harpies get an insignificant buff to their stamina drain as solace, and the same is true with large harpies and
/// their speed buff.
/// </remarks>
[RegisterComponent]
