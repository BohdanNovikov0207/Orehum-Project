...
public sealed class LastRolledAntagManager
{
    ...
    public void Initialize() => _sawmill = Logger.GetSawmill("last_antag");
    ...
    /// </summary>
    public TimeSpan GetLastRolled(NetUserId userId) => Task.Run(() => GetTimeAsync(userId)).GetAwaiter().GetResult();
