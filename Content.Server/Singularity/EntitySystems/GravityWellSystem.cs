...
public sealed class GravityWellSystem : SharedGravityWellSystem
{
    ...
    /// The amount to consider as having passed since the last gravitational pulse by the gravity well.
    /// Pulse force scales with this.
    /// </param>
    /// <param name="xform">The transform of the gravity well to make pulse.</param>
    ...
    /// <param name="baseMatrixDeltaV">
    /// The base velocity added to any entities within affected by the gravity pulse scaled by
    /// the displacement of those entities from the epicenter.
    /// </param>
    ...
    /// <param name="maxRange">The maximum distance at which entities can be affected by the gravity pulse.</param>
    /// <param name="minRange">The minimum distance at which entities can be affected by the gravity pulse.</param>
    /// <param name="baseRadialDeltaV">
    /// The base radial velocity that will be added to entities within range towards the center
    /// of the gravitational pulse.
    /// </param>
    /// <param name="baseTangentialDeltaV">
    /// The base tangential velocity that will be added to entities within countrclockwise
    /// around the center of the gravitational pulse.
    /// </param>
    /// <param name="xform">(optional) The transform of the entity at the epicenter of the gravitational pulse.</param>
    public void GravPulse(EntityUid uid,
        float maxRange,
    ...
    /// <param name="maxRange">The maximum distance at which entities can be affected by the gravity pulse.</param>
    /// <param name="minRange">
    /// The minimum distance at which entities can be affected by the gravity pulse. Exists to prevent
    /// div/0 errors.
    /// </param>
    /// <param name="baseMatrixDeltaV">
    /// The base velocity added to any entities within affected by the gravity pulse scaled by
    ...
    /// </param>
    /// <param name="baseRadialDeltaV">
    /// The base amount of velocity that will be added to entities in range towards the
    /// epicenter of the pulse.
    /// </param>
    /// <param name="baseTangentialDeltaV">
    /// The base amount of velocity that will be added to entities in range counterclockwise
    /// relative to the epicenter of the pulse.
    /// </param>
