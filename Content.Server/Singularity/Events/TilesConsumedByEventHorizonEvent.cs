    ...
    EventHorizonComponent eventHorizon)
{
    ...
    /// Ripped directly from the relevant proc so the second element of each element will be what the tiles are going to be
    /// after the grid is updated; usually <see cref="Tile.Empty" />.
    /// </summary>
