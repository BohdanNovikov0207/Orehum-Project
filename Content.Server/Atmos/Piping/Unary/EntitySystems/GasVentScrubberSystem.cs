...
public sealed class GasVentScrubberSystem : EntitySystem
{
    ...
    private void OnVentScrubberUpdated(EntityUid uid,
    ...
    private void OnVentScrubberLeaveAtmosphere(EntityUid uid,
        GasVentScrubberComponent component,
        AtmosDeviceDisabledEvent args) => UpdateState(uid, component);

    private void OnVentScrubberEnterAtmosphere(EntityUid uid,
        GasVentScrubberComponent component,
        AtmosDeviceEnabledEvent args) => UpdateState(uid, component);

    private void Scrub(float timeDelta, GasVentScrubberComponent scrubber, GasMixture? tile, PipeNode outlet) => Scrub(
        timeDelta,
    ...
    /// </summary>
    public bool Scrub(float timeDelta,
        float transferRate,
    ...
    private void OnPacketRecv(EntityUid uid, GasVentScrubberComponent component, DeviceNetworkPacketEvent args)
    {
        ...
        switch (cmd)
        {
            ...
            case DeviceNetworkConstants.CmdSetState:
                ...
                {
                    var enabled = setData.WideNet ? "enabled" : "disabled";
                    _adminLogger.Add(LogType.AtmosDeviceSetting,
                        LogImpact.Medium,
