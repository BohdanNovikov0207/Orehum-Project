...
public sealed partial class AtmosphereSystem
{
    ...
    private void InitializeCVars()
    {
        ...
        Subs.CVar(_cfg,
            GoobCVars.SpaceWindMinimumCalculatedMass,
            value => SpaceWindMinimumCalculatedMass = value,
            true); // Goobstation - Spacewind Cvars
        Subs.CVar(_cfg,
            GoobCVars.SpaceWindMaximumCalculatedInverseMass,
            value => SpaceWindMaximumCalculatedInverseMass = value,
            true); // Goobstation - Spacewind Cvars
        Subs.CVar(_cfg,
            GoobCVars.MonstermosUseExpensiveAirflow,
            value => MonstermosUseExpensiveAirflow = value,
            true); // Goobstation - Spacewind Cvars
        ...
        Subs.CVar(_cfg,
            GoobCVars.MonstermosRipTilesMinimumPressure,
            value => MonstermosRipTilesMinimumPressure = value,
            true);
        Subs.CVar(_cfg,
            GoobCVars.MonstermosRipTilesPressureOffset,
            value => MonstermosRipTilesPressureOffset = value,
            true);
