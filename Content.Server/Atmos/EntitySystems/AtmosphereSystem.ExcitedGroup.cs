...
public sealed partial class AtmosphereSystem
{
    ...
    private void ExcitedGroupMerge(GridAtmosphereComponent gridAtmosphere,
        ...
        ExcitedGroup otherGroup)
    {
        ...
        DebugTools.Assert(gridAtmosphere.ExcitedGroups.Contains(ourGroup),
            "Grid Atmosphere does not contain Excited Group!");
        DebugTools.Assert(gridAtmosphere.ExcitedGroups.Contains(otherGroup),
            "Grid Atmosphere does not contain Excited Group!");
    ...
    {
        DebugTools.Assert(!excitedGroup.Disposed, "Excited group is disposed!");
        DebugTools.Assert(ent.Comp1.ExcitedGroups.Contains(excitedGroup),
            "Grid Atmosphere does not contain Excited Group!");
    ...
    private void ExcitedGroupDispose(GridAtmosphereComponent gridAtmosphere, ExcitedGroup excitedGroup)
    {
        ...
        DebugTools.Assert(gridAtmosphere.ExcitedGroups.Contains(excitedGroup),
            "Grid Atmosphere does not contain Excited Group!");
