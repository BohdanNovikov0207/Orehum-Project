...
{
    /// <summary>
    /// The delta from the target temperature after which the space heater switch mode while in Auto. Value should account for
    /// the thermomachine temperature tolerance.
    /// </summary>
    [DataField]
    ...
    /// <summary>
    /// Current electrical power consumption, in watts, of the space heater at medium power level. Passed to the thermomachine
    /// component.
    /// </summary>
    [DataField] [ViewVariables(VVAccess.ReadWrite)]
