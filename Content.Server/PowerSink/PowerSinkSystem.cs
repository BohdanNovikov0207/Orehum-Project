...
public sealed class PowerSinkSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var query =
            EntityQueryEnumerator<PowerSinkComponent, PowerConsumerComponent, BatteryComponent, TransformComponent>();
            ...
            foreach (var testThreshold in _warningSoundThresholds)
            {
                    ...
                    testThreshold > component.HighestWarningSoundThreshold)
                {
                    component.HighestWarningSoundThreshold =
                        currentBatteryThreshold; // Don't re-play in future until next threshold hit
