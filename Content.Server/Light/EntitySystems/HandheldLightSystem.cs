...
public sealed class HandheldLightSystem : SharedHandheldLightSystem
{
    ...
    private void OnGetState(Entity<HandheldLightComponent> ent, ref ComponentGetState args) => args.State =
        new HandheldLightComponent.HandheldLightComponentState(ent.Comp.Activated, GetLevel(ent));
    ...
    private byte? GetLevel(Entity<HandheldLightComponent> ent)
    {
        ...
        return (byte?) ContentHelpers.RoundToNearestLevels(battery.CurrentCharge / battery.MaxCharge * 255,
            255,
            HandheldLightComponent.StatusLevels);
    }

    private void OnRemove(Entity<HandheldLightComponent> ent, ref ComponentRemove args) => _activeLights.Remove(ent);
    ...
    public bool ToggleStatus(EntityUid user, Entity<HandheldLightComponent> ent) =>
        ent.Comp.Activated ? TurnOff(ent) : TurnOn(user, ent);
