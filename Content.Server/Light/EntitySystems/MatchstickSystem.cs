...
public sealed class MatchstickSystem : SharedMatchstickSystem // Shitmed Change
{
    ...
    private void OnShutdown(Entity<MatchstickComponent> ent, ref ComponentShutdown args) => _litMatches.Remove(ent);
    ...
    public void Ignite(Entity<MatchstickComponent> matchstick, EntityUid user)
    {
        ...
        matchstick.Owner.SpawnTimer(component.Duration * 1000,
            delegate
            {
