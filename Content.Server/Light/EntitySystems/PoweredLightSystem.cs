...
public sealed class PoweredLightSystem : EntitySystem
{
    ...
    private void OnInteractHand(EntityUid uid, PoweredLightComponent light, InteractHandEvent args)
    {
        ...
        _doAfterSystem.TryStartDoAfter(
            new DoAfterArgs(EntityManager, userUid, light.EjectBulbDelay, new PoweredLightDoAfterEvent(), uid, uid)
            {
                BreakOnMove = true,
                BreakOnDamage = true,
            });
    ...
    public bool ReplaceBulb(EntityUid uid,
        EntityUid bulb,
        out EntityUid? oldBulb,
        PoweredLightComponent? light = null) // Goobstation
    {
