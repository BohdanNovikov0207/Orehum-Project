...
public sealed class PdaSystem : SharedPdaSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<PdaComponent, InventoryRelayedEvent<ChameleonControllerOutfitSelectedEvent>>(
            ChameleonControllerOutfitItemSelected);
    }

    private void ChameleonControllerOutfitItemSelected(Entity<PdaComponent> ent,
    ...
    private void OnStationRenamed(StationRenamedEvent ev) => UpdateAllPdaUisOnStation();
    ...
    private void OnUiMessage(EntityUid uid, PdaComponent pda, PdaToggleFlashlightMessage msg)
    {
        ...
        _unpoweredFlashlight.TryToggleLight(uid, null);
    }
    ...
    private bool IsUnlocked(EntityUid uid) => !TryComp<RingerUplinkComponent>(uid, out var uplink) || uplink.Unlocked;
