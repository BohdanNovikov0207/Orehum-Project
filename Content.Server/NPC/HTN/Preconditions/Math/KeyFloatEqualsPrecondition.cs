...
/// in the <see cref="NPCBlackboard" /> and the specified value is equal to the
/// <see cref="KeyFloatEqualsPrecondition.Value" />.
/// </summary>
public sealed partial class KeyFloatEqualsPrecondition : HTNPrecondition
{
    ...
    public override bool IsMet(NPCBlackboard blackboard) =>
        blackboard.TryGetValue<float>(Key, out var value, _entManager) &&
