...
/// in the <see cref="NPCBlackboard" /> and the specified value is greater then
/// <see cref="KeyFloatGreaterPrecondition.Value" />.
/// </summary>
public sealed partial class KeyFloatGreaterPrecondition : HTNPrecondition
{
    ...
    public override bool IsMet(NPCBlackboard blackboard) =>
        blackboard.TryGetValue<float>(Key, out var value, _entManager) && value > Value;
}
