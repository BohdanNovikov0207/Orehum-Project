...
public sealed class UniversalJsonConverter<T> : JsonConverter<T>
{
    ...
    public override T Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) => throw
    ...
    public override void Write(Utf8JsonWriter writer, T obj, JsonSerializerOptions options)
    {
        ...
        foreach (var field in fields)
        {
            ...
            if (Attribute.GetCustomAttribute(field, typeof(CompilerGeneratedAttribute), true) != null)
                continue;

            // If the field has a [JsonPropertyName] attribute, get the property name. Otherwise, use the field name.
            var attr = (JsonPropertyNameAttribute?) Attribute.GetCustomAttribute(field,
        ...
        foreach (var prop in properties)
        {
            ...
            var attr = (JsonPropertyNameAttribute?) Attribute.GetCustomAttribute(prop,
                typeof(JsonPropertyNameAttribute),
                true);
