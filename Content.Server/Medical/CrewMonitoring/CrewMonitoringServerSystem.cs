...
public sealed class CrewMonitoringServerSystem : EntitySystem
{
    ...
    /// </summary>
    private void BroadcastSensorStatus(EntityUid uid,
    ...
    /// </summary>
    private void OnDisconnected(EntityUid uid,
        CrewMonitoringServerComponent component,
        ref DeviceNetServerDisconnectedEvent _) => component.SensorStatus.Clear();
}
