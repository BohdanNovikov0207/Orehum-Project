...
public sealed class ArcadeSystem : EntitySystem
{
    ...
    public HighScorePlacement RegisterHighScore(string name, int score)
    {
        ...
        return new HighScorePlacement(TryInsertIntoList(_roundHighscores, entry),
    ...
    private int? TryInsertIntoList(List<BlockGameMessages.HighScoreEntry> highScoreEntries,
    ...
    private int? GetPlacement(List<BlockGameMessages.HighScoreEntry> highScoreEntries,
        BlockGameMessages.HighScoreEntry entry)
    {
        int? placement = null;
