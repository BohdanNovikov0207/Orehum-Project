...
public sealed class DecalSystem : SharedDecalSystem
{
    ...
    private void OnPlayerStatusChanged(object? sender, SessionStatusEventArgs e)
    {
        switch (e.NewStatus)
        {
            case SessionStatus.InGame:
                _previousSentChunks[e.Session] = new Dictionary<NetEntity, HashSet<Vector2i>>();
                break;
    ...
    /// <summary>
    /// Changes a decals position. Note this will actually result in a new decal being created, possibly on a new grid or
    /// chunk.
    /// </summary>
    /// <remarks>
    ...
    private record struct UpdatePlayerJob : IParallelRobustJob
    {
        ...
        public void Execute(int index) => System.UpdatePlayer(Sessions[index]);
    }
