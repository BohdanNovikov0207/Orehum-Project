...
public sealed class StationSystem : SharedStationSystem
{
    ...
    public EntityUid InitializeNewStation(StationConfig stationConfig,
        IEnumerable<EntityUid>? gridIds,
        string? name = null)
    {
        // Use overrides for setup.
        var station = EntityManager.SpawnEntity(stationConfig.StationPrototype,
        ...
        DebugTools.Assert(HasComp<StationDataComponent>(station),
    ...
    public void AddGridToStation(EntityUid station,
        EntityUid mapGrid,
    ...
    /// <param name="stationData">Resolve pattern, station data component of station.</param>
    /// <exception cref="ArgumentException">Thrown when mapGrid or station are not a grid or station, respectively.</exception>
    public void RemoveGridFromStation(EntityUid station,
        EntityUid mapGrid,
        MapGridComponent? gridComponent = null,
        StationDataComponent? stationData = null)
    {
    ...
    public void RenameStation(EntityUid station,
        string name,
        bool loud = true,
        StationDataComponent? stationData = null,
