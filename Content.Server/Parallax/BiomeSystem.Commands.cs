...
public sealed partial class BiomeSystem
{
    ...
    {
        if (args.Length == 1)
            return CompletionResult.FromHintOptions(CompletionHelper.Components<BiomeComponent>(args[0], EntityManager),
                "Biome");
