...
public sealed partial class TabletopSystem
{
    ...
    /// <param name="uid">The UID of the tabletop game entity.</param>
    /// <param name="removeGamerComponent">
    /// Whether to remove the <see cref="TabletopGamerComponent" /> from the player's
    /// attached entity.
    /// </param>
    public void CloseSessionFor(ICommonSession player, EntityUid uid, bool removeGamerComponent = true)
    {
        ...
        if (removeGamerComponent && player.AttachedEntity is { } attachedEntity &&
            TryComp(attachedEntity, out TabletopGamerComponent? gamer))
        {
