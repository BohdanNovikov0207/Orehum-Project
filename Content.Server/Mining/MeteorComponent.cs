...
/// <summary>
/// This is used for meteors which hit objects, dealing damage to destroy/kill the object and dealing equal damage back to
/// itself.
/// </summary>
...
{
    /// <summary>
    /// Damage specifier that is multiplied against the calculated damage amount to determine what damage is applied to the
    /// colliding entity.
    /// </summary>
    /// <remarks>
