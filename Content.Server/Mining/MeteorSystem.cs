...
public sealed class MeteorSystem : EntitySystem
{
    ...
    /// <inheritdoc />
    public override void Initialize() => SubscribeLocalEvent<MeteorComponent, StartCollideEvent>(OnCollide);
    ...
    private void OnCollide(EntityUid uid, MeteorComponent component, ref StartCollideEvent args)
    {
        ...
        var maxMeteorDamage = _destructible.DestroyedAt(uid) - CompOrNull<DamageableComponent>(uid)?.TotalDamage ??
                              FixedPoint2.Zero;
