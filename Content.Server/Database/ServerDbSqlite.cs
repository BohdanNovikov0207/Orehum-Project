...
public sealed class ServerDbSqlite : ServerDbBase
{
    ...
    protected override async Task<DbGuard> GetDb(
        CancellationToken cancel = default,
        [CallerMemberName] string? name = null) =>
        await GetDbImpl(cancel, name).ConfigureAwait(false);
    ...
    private sealed class DbGuardImpl : DbGuard
    {
        ...
        public override ServerDbContext DbContext => SqliteDbContext;
        public SqliteServerDbContext SqliteDbContext { get; }
        ...
        ImmutableArray<ImmutableArray<byte>>? modernHWIds)
    {
        ...
        return (await GetServerBanQueryAsync(db, address, userId, hwId, modernHWIds, false)).FirstOrDefault();
    }
