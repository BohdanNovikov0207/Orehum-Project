...
public sealed class ServerDbManager : IServerDbManager
{
    ...
    public Task<IPIntelCache?> GetIPIntelCache(IPAddress ip) => RunDbCommand(() => _db.GetIPIntelCache(ip));
    ...
    public void InjectTestNotification(DatabaseNotification notification) => HandleDatabaseNotification(notification);
    ...
    private void SetupLogging(DbContextOptionsBuilder builder) => builder.UseLoggerFactory(_msLoggerFactory);
    ...
    private sealed class LoggingProvider : ILoggerProvider
    {
        ...
        public ILogger CreateLogger(string categoryName) => new MSLogger(_logManager.GetSawmill("db.ef"));
    }
    ...
    public Task<bool> RemovePollVoteAsync(int pollId,
        int optionId,
        NetUserId userId,
        CancellationToken cancel = default)
    {
...
internal sealed class SyncAsyncEnumerable<T> : IAsyncEnumerable<T>
{
    ...
    public IAsyncEnumerator<T> GetAsyncEnumerator(CancellationToken cancellationToken = default) =>
        new Enumerator(_enumerable.GetAsyncEnumerator(cancellationToken));
