...
public sealed class PowerReceiverSystem : SharedPowerReceiverSystem
{
    ...
    private void OnGetVerbs(EntityUid uid, ApcPowerReceiverComponent component, GetVerbsEvent<Verb> args)
    {
        ...
        args.Verbs.Add(new Verb
        {
            ...
            Icon = new SpriteSpecifier.Texture(
                new ResPath("/Textures/Interface/VerbIcons/smite.svg.192dpi.png")), // "smite" is a lightning bolt
            Act = () =>
            {
    ...
    private void OnProviderConnected(Entity<ApcPowerReceiverComponent> receiver,
    ...
    private void OnProviderDisconnected(Entity<ApcPowerReceiverComponent> receiver,
    ...
    private void OnReceiverConnected(Entity<ApcPowerProviderComponent> provider,
    ...
    private void OnReceiverDisconnected(EntityUid uid,
    ...
    public bool IsPowered(EntityUid uid, ApcPowerReceiverComponent? receiver = null) =>
        !_recQuery.Resolve(uid, ref receiver, false) || receiver.Powered;

    public override void
        SetLoad(SharedApcPowerReceiverComponent comp, float load) // Goobstation - override shared method
        =>
