...
public sealed partial class PowerSupplierComponent : BaseNetConnectorComponent<IBasePowerNet>
{
    ...
    protected override void AddSelfToNet(IBasePowerNet powerNet) => powerNet.AddSupplier(this);

    protected override void RemoveSelfFromNet(IBasePowerNet powerNet) => powerNet.RemoveSupplier(this);
}
