...
{
    protected override void AddSelfToNet(IPowerNet net) => net.AddDischarger(this);

    protected override void RemoveSelfFromNet(IPowerNet net) => net.RemoveDischarger(this);
}
