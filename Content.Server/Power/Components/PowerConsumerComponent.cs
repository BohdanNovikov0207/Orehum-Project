...
public sealed partial class PowerConsumerComponent : BaseNetConnectorComponent<IBasePowerNet>
{
    ...
    protected override void AddSelfToNet(IBasePowerNet powerNet) => powerNet.AddConsumer(this);

    protected override void RemoveSelfFromNet(IBasePowerNet powerNet) => powerNet.RemoveConsumer(this);
}
