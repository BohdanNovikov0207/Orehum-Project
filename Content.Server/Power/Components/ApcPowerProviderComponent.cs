...
public sealed partial class ApcPowerProviderComponent : BaseApcNetComponent
{
    ...
    protected override void AddSelfToNet(IApcNet apcNet) => apcNet.AddPowerProvider(this);

    protected override void RemoveSelfFromNet(IApcNet apcNet) => apcNet.RemovePowerProvider(this);
}
