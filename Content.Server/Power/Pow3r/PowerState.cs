...
public sealed class PowerState
{
    ...
    public readonly struct NodeId : IEquatable<NodeId>
    {
        ...
        public bool Equals(NodeId other) => Index == other.Index && Generation == other.Generation;
    ...
    public sealed class Supply
    {
        ...
        [ViewVariables]
        public float
            SupplyRampScaling = 1.2f; // if you want to set this below 1, you're very likely doing something wrong
