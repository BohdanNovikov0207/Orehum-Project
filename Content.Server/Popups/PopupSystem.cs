...
public sealed class PopupSystem : SharedPopupSystem
{
        ...
        PopupType type = PopupType.Small)
    {
        ...
        RaiseNetworkEvent(new PopupCoordinatesEvent(message, type, GetNetCoordinates(coordinates)),
            filter,
            replayRecord);
    }
    ...
    public override void PopupPredicted(string? recipientMessage,
        ...
        EntityUid uid,
        EntityUid? recipient,
        PopupType type = PopupType.Small) => PopupPredicted(othersMessage, uid, recipient, type);
}
