    ...
    public void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        switch (args.Length)
        {
            case 0:
                ...
                hand = _entManager.SpawnEntity(DefaultHandPrototype,
            ...
            case 1:
            {
                ...
                else
                {
                    ...
                    entity = player.AttachedEntity.Value;
                    hand = _entManager.SpawnEntity(args[0],
                        _entManager.GetComponent<TransformComponent>(entity).Coordinates);
                }
            ...
            case 2:
            {
                ...
                hand = _entManager.SpawnEntity(args[1],
                    _entManager.GetComponent<TransformComponent>(entity).Coordinates);
        ...
        if (!bodySystem.TryCreatePartSlotAndAttach(attachAt.Id,
                slotId,
                hand,
                BodyPartType.Hand,
