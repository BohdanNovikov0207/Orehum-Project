...
public sealed class CreamPieSystem : SharedCreamPieSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CreamPieComponent, ConsumeDoAfterEvent>(OnConsume, [typeof(FoodSystem)]);
    ...
    private void OnConsume(Entity<CreamPieComponent> entity, ref ConsumeDoAfterEvent args) => ActivatePayload(entity);

    private void OnSlice(Entity<CreamPieComponent> entity, ref SliceFoodEvent args) => ActivatePayload(entity);
    ...
    private void ActivatePayload(EntityUid uid)
    {
        ...
        {
            if (_itemSlots.TryEject(uid, itemSlot, null, out var item))
            {
