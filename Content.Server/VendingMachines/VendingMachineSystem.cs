...
public sealed class VendingMachineSystem : SharedVendingMachineSystem
{
    ...
    private void OnActivatableUIOpenAttempt(EntityUid uid,
    ...
    private void OnDamageChanged(EntityUid uid, VendingMachineComponent component, DamageChangedEvent args)
    {
            ...
            _random.Prob(component.DispenseOnHitChance.Value))
        {
            ...
            EjectRandom(uid, true, true, component);
        }
    }
    ...
    private void OnSelfDispense(EntityUid uid, VendingMachineComponent component, VendingMachineSelfDispenseEvent args)
    {
        ...
        args.Handled = true;
        EjectRandom(uid, true, false, component);
    }
    ...
    private void OnDoAfter(EntityUid uid, VendingMachineComponent component, DoAfterEvent args)
    {
        ...
        Popup.PopupEntity(Loc.GetString("vending-machine-restock-done-self", ("target", uid)),
            args.Args.User,
            args.Args.User,
            PopupType.Medium);
        var othersFilter = Filter.PvsExcept(args.Args.User);
        Popup.PopupEntity(
            Loc.GetString("vending-machine-restock-done-others",
    ...
    /// <param name="forceEject">
    /// Whether to skip the regular ejection checks and immediately dispense the item without
    /// animation.
    /// </param>
        ...
        VendingMachineComponent? vendComponent = null)
    {
        ...
        if (forceEject)
        {
            ...
            TryEjectVendorItem(uid, item.Type, item.ID, throwItem, null, vendComponent);
    }

    protected override void EjectItem(EntityUid uid,
        VendingMachineComponent? vendComponent = null,
        bool forceEject = false)
    {
        if (!Resolve(uid, ref vendComponent))
    ...
    private void OnPriceCalculation(EntityUid uid,
