...
internal sealed class PowerSolarControlConsoleSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        {
            _updateTimer -= 1;
            var state = new SolarControlConsoleBoundInterfaceState(_powerSolarSystem.TargetPanelRotation,
                _powerSolarSystem.TargetPanelVelocity,
                _powerSolarSystem.TotalPanelPower,
    ...
    private void OnUIMessage(EntityUid uid,
