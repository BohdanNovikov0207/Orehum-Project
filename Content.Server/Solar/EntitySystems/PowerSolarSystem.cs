...
{
    /// <summary>
    /// Maximum panel angular velocity range - used to stop people rotating panels fast enough that the lag prevention becomes
    /// noticable
    /// </summary>
    ...
    private void UpdatePanelCoverage(Entity<SolarPanelComponent> panel)
    {
        ...
        if (coverage > 0)
        {
            ...
            var ray = new CollisionRay(_transformSystem.GetWorldPosition(xform),
