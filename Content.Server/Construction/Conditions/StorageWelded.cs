...
public sealed partial class StorageWelded : IGraphCondition
{
    ...
    public bool Condition(EntityUid uid, IEntityManager entityManager) =>
        entityManager.System<WeldableSystem>().IsWelded(uid) == Welded;
    ...
    public bool DoExamine(ExaminedEvent args)
    {
        ...
        {
            if (Welded)
                args.PushMarkup(Loc.GetString("construction-examine-condition-door-weld",
                    ("entityName", metaData.EntityName)) + "\n");
            else
                args.PushMarkup(Loc.GetString("construction-examine-condition-door-unweld",
                    ("entityName", metaData.EntityName)) + "\n");
            return true;
        }
