...
public sealed partial class ConstructionSystem
{
    ...
    /// </summary>
    /// <remarks>
    /// When <see cref="validation" /> is true, this method will simply return whether the interaction
    ...
    private HandleResult HandleEvent(EntityUid uid,
        object ev,
        bool validation,
    ...
    /// </remarks>
    /// <returns>The result of this interaction with the entity.</returns>
    private HandleResult HandleNode(EntityUid uid,
        object ev,
    ...
    /// </remarks>
    /// <returns>The result of this interaction with the entity.</returns>
    private HandleResult HandleEdge(EntityUid uid,
        object ev,
    ...
    /// </remarks>
    /// <returns>The result of this interaction with the entity.</returns>
    private HandleResult HandleStep(EntityUid uid,
        object ev,
    ...
    /// </remarks>
    /// <returns>The result of this interaction with the entity.</returns>
    private HandleResult HandleInteraction(EntityUid uid,
        object ev,
        ConstructionGraphStep step,
        bool validation,
        out EntityUid? user,
        ...
        switch (step)
        {
            ...
            case EntityInsertConstructionGraphStep insertStep:
            {
                ...
                if (HasComp<UnremoveableComponent>(insert) &&
                    (!TryComp<StackComponent>(insert, out var comp) || !comp.Lingering))
                    return HandleResult.False;
                ...
                {
                    if (_stackSystem.Split(insert,
                            materialInsertStep.Amount,
                            Transform(interactUsing.User).Coordinates) is not { } stack)
                        return HandleResult.False;
            ...
            case TemperatureConstructionGraphStep temperatureChangeStep:
            {
                ...
                if ((!temperatureChangeStep.MinTemperature.HasValue ||
    ...
    /// <remarks>
    /// Events inheriting <see cref="HandledEntityEventArgs" /> are treated specially by this method.
