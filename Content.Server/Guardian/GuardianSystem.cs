...
public sealed class GuardianSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<GuardianHostComponent, MechPilotRelayedEvent<GettingAttackedAttemptEvent>>(
            OnPilotAttackAttempt);
    }
    ...
    private void OnPilotAttackAttempt(Entity<GuardianHostComponent> uid,
    ...
    private void OnDoAfter(EntityUid uid, GuardianCreatorComponent component, DoAfterEvent args)
    {
        ...
        if (args.Cancelled || component.Deleted || component.Used ||
            !_handsSystem.IsHolding(args.Args.User, uid, out _) || HasComp<GuardianHostComponent>(args.Args.Target))
            return;
        ...
        var guardian = Spawn(component.GuardianProto, _transform.GetMapCoordinates(args.Args.Target.Value, hostXform));
    ...
    private void OnHostStateChange(EntityUid uid, GuardianHostComponent component, MobStateChangedEvent args)
    {
        ...
        {
            _popupSystem.PopupEntity(Loc.GetString("guardian-host-critical-warn"),
    ...
    private void OnGuardianDamaged(EntityUid uid, GuardianComponent component, DamageChangedEvent args)
    {
        ...
        _popupSystem.PopupEntity(Loc.GetString("guardian-entity-taking-damage"),
    ...
    private void ReleaseGuardian(EntityUid host,
    ...
    private void RetractGuardian(EntityUid host,
        GuardianHostComponent hostComponent,
        EntityUid guardian,
        GuardianComponent guardianComponent)
    {
