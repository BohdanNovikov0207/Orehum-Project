...
public sealed class MutingSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<MutedComponent, EmoteEvent>(OnEmote,
            new[] { typeof(VocalSystem), typeof(MumbleAccentSystem) });
        SubscribeLocalEvent<MutedComponent, ScreamActionEvent>(OnScreamAction, new[] { typeof(VocalSystem) });
    }
