...
public sealed class StutteringSystem : SharedStutteringSystem
{
    ...
    [Dependency] private readonly Shared.StatusEffectNew.StatusEffectsSystem _statusEffectsSystem = default!;

    public override void Initialize() => SubscribeLocalEvent<StutteringAccentComponent, AccentGetEvent>(OnAccent);
