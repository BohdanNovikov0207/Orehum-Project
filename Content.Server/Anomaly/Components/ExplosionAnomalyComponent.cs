...
{
    /// <summary>
    /// How quickly does the explosion's power slope? Higher = smaller area and more concentrated damage, lower = larger area
    /// and more spread out damage
    /// </summary>
    ...
    /// </summary>
    [DataField("supercriticalExplosion",
        required: true,
