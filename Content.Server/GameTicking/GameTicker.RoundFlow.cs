...
public sealed partial class GameTicker
{
        ...
        Angle? rot = null)
    {
        ...
        {
            var mapUid = _map.CreateMap(out mapId, options?.InitializeMaps ?? false);
    ...
    public void RestartRound()
    {
        ...
        else
        {
            ...
            _taskManager.RunOnMainThread(() => _voteManager.CreateStandardVote(null, StandardVoteType.Preset));
        }
    }
...
public sealed class RefreshLateJoinAllowedEvent
{
    ...
    public void Disallow() => DisallowLateJoin = true;
}
...
public sealed class RulePlayerSpawningEvent
{
    ...
    /// </summary>
    /// <remarks>
    /// If you spawn a player by yourself from this event, don't forget to call
    /// <see cref="GameTicker.PlayerJoinGame" /> on them.
    /// </remarks>
...
public sealed class RoundEndTextAppendEvent
{
    ...
    // goob edit
    public void AppendAtStart(string text) => Text = text + Text;
}
