...
using ShowContrabandIconsComponent =
    Content.Goobstation.Shared.Security.ContrabandIcons.Components.ShowContrabandIconsComponent;
using VisibleContrabandComponent =
    Content.Goobstation.Shared.Security.ContrabandIcons.Components.VisibleContrabandComponent;
