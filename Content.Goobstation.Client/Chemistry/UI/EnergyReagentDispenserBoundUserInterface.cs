    ...
    : BoundUserInterface(owner, uiKey)
{
    ...
    protected override void Open()
    {
        ...
        _window.EjectButton.OnPressed += _ =>
            SendMessage(new ItemSlotButtonPressedEvent(SharedEnergyReagentDispenser.OutputSlotName));
        ...
        _window.OnDispenseReagentButtonPressed += reagentId =>
            SendMessage(new EnergyReagentDispenserDispenseReagentMessage(reagentId));
    }
