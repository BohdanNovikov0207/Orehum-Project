...
public sealed class InputSwapResyncSystem : EntitySystem
{
    ...
    public override void Initialize() => _stateMan.GameStateApplied += ReapplyModifier;

    public override void Shutdown() => _stateMan.GameStateApplied -= ReapplyModifier;

    /// This is abysmal dogshit
    /// This exists purely because a component cannot modify another during application state (why the fuck is
    /// <see cref="StateApplicationGuard" />
    /// a thing?)
