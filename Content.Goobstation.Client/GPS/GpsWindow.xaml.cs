...
public sealed partial class GpsWindow : BaseWindow
{
    ...
    public void UpdateState(EntityUid owner)
    {
        ...
        EnabledButton.Text = gps.Enabled
            ? Loc.GetString("gps-window-visibility-on")
            : Loc.GetString("gps-window-visibility-off");
    ...
    public void UpdateGpsEntries(List<GpsEntry> gpsEntries, NetEntity? trackedEntity)
    {
        ...
        foreach (var entry in sortedEntries)
        {
            ...
            var item = new GpsListEntry(entry.Name ?? Loc.GetString("generic-unknown-title"),
                entry.NetEntity,
                sprite,
                entry.Color);
