...
1. Open [orehum-gameplay-map.md](references/orehum-gameplay-map.md) first.
- Use it to map the request to assemblies, domain folders, paired resource files, and fork-specific `_Orehum` areas.
...
- `references/orehum-gameplay-map.md`: repo-specific subsystem map, folder routing, `_Orehum` extensions, and common pairings between code and resources.
