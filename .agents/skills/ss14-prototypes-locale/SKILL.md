...
- Use it to choose the correct `Resources/` subtree, understand folder naming drift, and find fork-specific `_Orehum` content.
...
- `references/resources-map.md`: subtree map for prototypes, locale, textures, audio, maps, and `_Orehum` additions in this fork.
