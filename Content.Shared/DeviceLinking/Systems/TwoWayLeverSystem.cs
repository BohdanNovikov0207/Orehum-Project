...
public sealed class TwoWayLeverSystem : EntitySystem
{
        ...
        GetVerbsEvent<InteractionVerb> args)
    {
        ...
        InteractionVerb verbLeft = new()
        {
            ...
            Disabled = disabled,
            Icon = new SpriteSpecifier.Texture(new ResPath($"/Textures/Interface/VerbIcons/{_leftToggleImage}")),
        ...
        InteractionVerb verbRight = new()
        {
            ...
            Message = disabled ? Loc.GetString("two-way-lever-cant") : null,
            Disabled = disabled,
            Icon = new SpriteSpecifier.Texture(new ResPath($"/Textures/Interface/VerbIcons/{_rightToggleImage}")),
