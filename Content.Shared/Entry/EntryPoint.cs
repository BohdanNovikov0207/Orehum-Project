...
public sealed class EntryPoint : GameShared
{
    ...
    public override void Shutdown() => _prototypeManager.PrototypesReloaded -= PrototypeReload;

    public override void Init() => IgnorePrototypes();
    ...
    private void VerifyModules()
    {
        ...
        foreach (var module in packs)
        {
            ...
            throw new InvalidOperationException(
                $"Missing required assemblies to build. Try deleting your bin folder, running dotnet clean, and rebuilding the {module.PackName} solution.\nMissing Modules:\n{string.Join("\n", missing.Select(t => t.AssemblyName))}");
        }
    }
