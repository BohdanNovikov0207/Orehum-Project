...
public abstract class SharedOrdersSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<OrdersComponent, ComponentGetStateAttemptEvent>(OnComponentGetState);
        ...
        SubscribeLocalEvent<OrdersComponent, FocusActionEvent>(OnAction);
        SubscribeLocalEvent<OrdersComponent, HoldActionEvent>(OnAction);
        SubscribeLocalEvent<OrdersComponent, MoveActionEvent>(OnAction);
    ...
    /// </summary>
    private void AddOrder(EntityUid uid, Orders order, OrdersComponent orderComp)
    {
        switch (order)
        {
            case Orders.Focus:
