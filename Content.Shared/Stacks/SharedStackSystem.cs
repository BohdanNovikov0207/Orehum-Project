...
public abstract class SharedStackSystem : EntitySystem
{
        ...
        StackComponent? recipientStack = null)
    {
        ...
        if (string.IsNullOrEmpty(recipientStack.StackTypeId) ||
        ...
        HandsComponent? hands = null)
    {
        ...
        {
            TryMergeStacks(item, held, out _, itemStack);
    ...
    /// </summary>
    public virtual EntityUid? Split(EntityUid uid,
        int amount,
        EntityCoordinates spawnPosition,
        StackComponent? stack = null) => null;
    ...
    public int GetCount(EntityUid uid, StackComponent? component = null) =>
        Resolve(uid, ref component, false) ? component.Count : 1;
    ...
    /// <returns></returns>
    [PublicAPI]
    public int GetMaxCount(EntityUid uid) => GetMaxCount(CompOrNull<StackComponent>(uid));
    ...
    /// <returns></returns>
    [PublicAPI]
    public int GetAvailableSpace(StackComponent component) => GetMaxCount(component) - component.Count;

    /// <summary>
    /// Tries to add one stack to another. May have some leftover count in the inserted entity.
    /// </summary>
    public bool TryAdd(EntityUid insertEnt,
        EntityUid targetEnt,
    ...
    private void OnStackGetState(EntityUid uid, StackComponent component, ref ComponentGetState args) => args.State =
        new StackComponentState(component.Count, component.MaxCountOverride, component.Lingering);
