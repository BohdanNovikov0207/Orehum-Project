...
public abstract class SharedJitteringSystem : EntitySystem
{
    ...
    public override void Initialize() => SubscribeLocalEvent<JitteringComponent, RejuvenateEvent>(OnRejuvenate);
    ...
    /// <param name="forceValueChange">
    /// Whether to change any existing jitter value even if they're greater than the ones we're
    /// setting.
    /// </param>
        ...
        StatusEffectsComponent? status = null)
    {
        ...
        if (StatusEffects.TryAddStatusEffect<JitteringComponent>(uid,
                "Jitter",
                time,
                refresh,
                status)) //todo goobstation migrate jitter.
        {
