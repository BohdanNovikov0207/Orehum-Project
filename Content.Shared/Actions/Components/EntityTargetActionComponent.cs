...
/// If used with <see cref="WorldTargetActionComponent" />, the event here can be set to null and <c>Optional</c> should be
/// set.
/// Then
/// <see cref="WorldActionEvent">
/// can have <c>TargetEntity</c> optionally set to the client's hovered entity, if it is valid.
