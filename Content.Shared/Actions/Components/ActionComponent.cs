...
public sealed partial class ActionComponent : Component
{
    ...
    /// <summary>
    /// If true, this will cause the the action event to always be raised directed at the action performer/user instead of the
    /// action's container/provider.
    /// </summary>
    [DataField] [AutoNetworkedField]
    ...
    /// <summary>
    /// The toggle state of this action. Toggling switches the currently displayed icon, see <see cref="Icon" /> and
    /// <see cref="IconOn" />.
    /// </summary>
    /// <remarks>
