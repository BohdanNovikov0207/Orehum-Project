...
/// </summary>
/// <remarks>
/// Note that a system could also just manually add actions as a result of a <see cref="GotEquippedEvent" /> or
/// <see
///     cref="GotEquippedHandEvent" />
/// . This exists mostly as a convenience event, while also helping to keep
...
public sealed class GetItemActionsEvent : EntityEventArgs
{
    ...
    /// <see
    ///     cref="AddAction(ref System.Nullable{Robust.Shared.GameObjects.EntityUid},string,Robust.Shared.GameObjects.EntityUid)" />
    /// .
    ...
    public GetItemActionsEvent(ActionContainerSystem system,
        ...
        bool isEquipping = true) // Lavaland Change - added isEquipping
    {
        _system = system;
        User = user;
        Provider = provider;
...
/// <summary>
/// This is the type of event that gets raised when an <see cref="InstantAction" /> is performed. The
/// <see
///     cref="Performer" />
/// field is automatically filled out by the <see cref="SharedActionsSystem" />.
/// </summary>
/// <remarks>
...
/// <summary>
/// This is the type of event that gets raised when an <see cref="EntityTargetAction" /> is performed. The
/// <see
///     cref="Performer" />
/// and <see cref="Target" /> fields will automatically be filled out by the
/// <see
...
/// <summary>
/// This is the type of event that gets raised when an <see cref="WorldTargetAction" /> is performed. The
/// <see
///     cref="Performer" />
/// and <see cref="Target" /> fields will automatically be filled out by the
/// <see
...
{
    /// <summary>
    /// When combined with <see cref="EntityTargetAction" /> (and <c>Event</c> is null), the entity the client was hovering
    /// when clicked.
...
/// <summary>
/// Base class for events that are raised when an action gets performed. This should not generally be used outside of the
/// action
/// system.
/// </summary>
