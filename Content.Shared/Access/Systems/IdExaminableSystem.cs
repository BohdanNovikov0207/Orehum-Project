...
public sealed class IdExaminableSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<IdExaminableComponent, GetVerbsEvent<AlternativeVerb>>(
            OnWantedMenuOpen); // Goobstation-WantedMenu
    }
    ...
    private void OnGetExamineVerbs(EntityUid uid, IdExaminableComponent component, GetVerbsEvent<ExamineVerb> args)
    {
        ...
        var wantedVerb = new ExamineVerb
        {
            ...
            Disabled = !detailsRange,
            Message = detailsRange ? null : Loc.GetString("id-examinable-component-verb-disabled"),
            Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/_Goobstation/Interface/VerbIcons/wanted.png")),
            Priority = 1,
        };
    ...
    public string GetMessage(EntityUid uid) => GetInfo(uid) ?? Loc.GetString("id-examinable-component-verb-no-id");
