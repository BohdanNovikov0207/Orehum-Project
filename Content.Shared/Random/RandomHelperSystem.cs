...
public sealed class RandomHelperSystem : EntitySystem
{
    ...
    public void RandomOffset(EntityUid entity, float min, float max) => RandomOffset(entity, min, max, min, max);

    public void RandomOffset(EntityUid entity, float value) => RandomOffset(entity, -value, value);
}
