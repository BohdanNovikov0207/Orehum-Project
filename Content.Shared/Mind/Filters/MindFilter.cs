...
public abstract partial class MindFilter
{
    ...
    protected abstract bool ShouldRemove(Entity<MindComponent> mind,
        EntityUid? exclude,
    ...
    /// </summary>
    public bool Filter(Entity<MindComponent> mind,
        EntityUid? exclude,
        EntityManager entMan,
        SharedMindSystem mindSys) => ShouldRemove(mind, exclude, entMan, mindSys) ^ Inverted;
}
