...
public sealed partial class MindComponent : Component
{
    ...
    public List<EntityUid> MindRoles = new();
    ...
    /// <summary>
    /// The entity that this mind may be currently visiting. Used, for example, to allow admin ghosting to not make the owner's
    /// body catatonic, as opposed to when normally ghosting.
    /// </summary>
    [DataField] [AutoNetworkedField] [Access(typeof(SharedMindSystem))]
