...
public static class ContentKeyFunctions
{
    ...
    public static readonly BoundKeyFunction
        FocusCollectiveMindChat = "FocusCollectiveMindChatWindow"; // Goobstation - Starlight collective mind port
    ...
    public static BoundKeyFunction[] GetHotbarBoundKeys() =>
        new[]
        {
            ...
            HotbarShift1, HotbarShift2, HotbarShift3, HotbarShift4, HotbarShift5, HotbarShift6, HotbarShift7,
            HotbarShift8, HotbarShift9, HotbarShift0,
        };
}
