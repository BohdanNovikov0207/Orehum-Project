...
public abstract partial class ExamineSystemShared : EntitySystem
{
        ...
        bool isHoverExamine = false)
    {
        ...
        var examineVerb = new ExamineVerb
        {
            ...
            Category = VerbCategory.Examine,
            Icon = new SpriteSpecifier.Texture(new ResPath(iconTexture)),
    ...
    public void AddDetailedExamineVerb(GetVerbsEvent<ExamineVerb> verbsEvent,
        ...
        string iconTexture = DefaultIconTexture,
        string hoverMessage = "",
        bool isHoverExamine = false) => AddDetailedExamineVerb(verbsEvent,
        component,
    ...
    {
        var componentName = Factory.GetComponentName(component.GetType());
        AddDetailedExamineVerb(verbsEvent,
            component,
    ...
    /// </summary>
    public void AddHoverExamineVerb(GetVerbsEvent<ExamineVerb> verbsEvent,
        Component component,
        string verbText,
        string hoverMessage,
        string iconTexture = DefaultIconTexture) => AddDetailedExamineVerb(verbsEvent,
        component,
