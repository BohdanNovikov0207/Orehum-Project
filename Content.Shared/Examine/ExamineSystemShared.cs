...
public abstract partial class ExamineSystemShared : EntitySystem
{
    ...
    {
        if (Resolve(examiner, ref mobState, false))
        {
    ...
    /// </summary>
    public bool IsOccluded(EntityUid uid) => TryComp<EyeComponent>(uid, out var eye) && eye.DrawFov;
...
public sealed class ExaminedEvent : EntityEventArgs
{
    ...
    {
        private readonly ExaminedEvent _event;
        ...
        public void Dispose() => _event.PopGroup();
    }
