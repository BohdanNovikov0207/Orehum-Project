...
public abstract class SharedElectrocutionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<InsulatedComponent, InventoryRelayedEvent<ElectrocutionAttemptEvent>>((e, c, ev) =>
            OnInsulatedElectrocutionAttempt(e, c, ev.Args));
    }

    public void SetInsulatedSiemensCoefficient(EntityUid uid,
    ...
    /// <param name="refresh">
    /// Should <paramref>time</paramref> be refreshed (instead of accumilated) if the entity is already
    /// electrocuted?
    /// </param>
    /// <param name="siemensCoefficient">
    /// How insulated the entity is from the shock. 0 means completely insulated, and 1 means
    /// no insulation.
    /// </param>
    ...
    private void OnInsulatedElectrocutionAttempt(EntityUid uid,
        InsulatedComponent insulated,
        ElectrocutionAttemptEvent args) => args.SiemensCoefficient *= insulated.Coefficient;
}
