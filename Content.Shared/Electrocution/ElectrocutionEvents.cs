...
public sealed class ElectrocutionAttemptEvent : CancellableEntityEventArgs, IInventoryRelayEvent
{
    ...
    public ElectrocutionAttemptEvent(EntityUid targetUid,
        EntityUid? sourceUid,
...
{
    public readonly float? ShockDamage; // Goobstation
    public readonly float SiemensCoefficient;
    public readonly EntityUid? SourceUid;
    public readonly EntityUid TargetUid;

    public ElectrocutedEvent(EntityUid targetUid,
        EntityUid? sourceUid,
        float siemensCoefficient,
        float shockDamage) // Goobstation
    {
        TargetUid = targetUid;
        SourceUid = sourceUid;
        SiemensCoefficient = siemensCoefficient;
