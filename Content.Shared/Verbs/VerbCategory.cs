...
public sealed class VerbCategory
{
    ...
    public static readonly VerbCategory Antag =
        new("verb-categories-antag", "/Textures/Interface/VerbIcons/antag-e_sword-temp.192dpi.png", true)
            { Columns = 5 };
    ...
    public static readonly VerbCategory Rotate =
        new("verb-categories-rotate", "/Textures/Interface/VerbIcons/refresh.svg.192dpi.png", true) { Columns = 5 };

    public static readonly VerbCategory Smite =
        new("verb-categories-smite", "/Textures/Interface/VerbIcons/smite.svg.192dpi.png", true) { Columns = 6 };

    public static readonly VerbCategory Tricks =
        new("verb-categories-tricks", "/Textures/Interface/AdminActions/tricks.png", true) { Columns = 5 };
    ...
    public VerbCategory(string text, string? icon, bool iconsOnly = false)
    {
        ...
        Icon = icon == null ? null : new SpriteSpecifier.Texture(new ResPath(icon));
        IconsOnly = iconsOnly;
    }
}
