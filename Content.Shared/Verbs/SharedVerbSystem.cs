...
public abstract class SharedVerbSystem : EntitySystem
{
    ...
    public SortedSet<Verb> GetLocalVerbs(EntityUid target, EntityUid user, Type type, bool force = false) =>
        GetLocalVerbs(target, user, new List<Type> { type }, force);

    /// <inheritdoc
    ///     cref="GetLocalVerbs(Robust.Shared.GameObjects.EntityUid,Robust.Shared.GameObjects.EntityUid,System.Type,bool)" />
    public SortedSet<Verb> GetLocalVerbs(EntityUid target, EntityUid user, List<Type> types, bool force = false) =>
        GetLocalVerbs(target, user, types, out _, force);
        ...
        bool force = false)
    {
        ...
        {
            var verbEvent = new GetVerbsEvent<InteractionVerb>(user,
                target,
                @using,
                hands,
                canInteract,
        ...
        if (types.Contains(typeof(UtilityVerb))
            ...
            && @using != target)
        {
            var verbEvent = new GetVerbsEvent<UtilityVerb>(user,
                target,
                @using,
                hands,
                canInteract,
        ...
        {
            var verbEvent = new GetVerbsEvent<InnateVerb>(user,
                target,
                @using,
                hands,
                canInteract,
        ...
        {
            var verbEvent = new GetVerbsEvent<AlternativeVerb>(user,
                target,
                @using,
                hands,
                canInteract,
        ...
        {
            var verbEvent = new GetVerbsEvent<ActivationVerb>(user,
                target,
                @using,
                hands,
                canInteract,
        ...
        {
            var verbEvent = new GetVerbsEvent<ExamineVerb>(user,
                target,
                @using,
                hands,
                canInteract,
        ...
        {
            var verbEvent = new GetVerbsEvent<Verb>(user,
                target,
                @using,
                hands,
                canInteract,
        ...
        if (types.Contains(typeof(EquipmentVerb)))
        {
            ...
            var verbEvent = new GetVerbsEvent<EquipmentVerb>(user,
                target,
                @using,
                hands,
                canInteract,
