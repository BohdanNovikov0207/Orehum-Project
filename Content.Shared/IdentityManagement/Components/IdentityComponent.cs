...
/// </summary>
/// <remarks>
/// This is a <see cref="ContainerSlot" /> and not just a datum entity because we do sort of care that it gets deleted and
/// sent with the user.
/// </remarks>
[RegisterComponent]
...
public sealed class IdentityRepresentation
{
    ...
    public IdentityRepresentation(string trueName,
        Gender trueGender,
        string ageString,
