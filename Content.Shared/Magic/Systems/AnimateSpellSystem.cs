...
public sealed class AnimateSpellSystem : EntitySystem
{
    ...
    public override void Initialize() => SubscribeLocalEvent<AnimateComponent, MapInitEvent>(OnAnimate);
    ...
    private void OnAnimate(Entity<AnimateComponent> ent, ref MapInitEvent args)
    {
        ...
        _physics.SetCollisionMask(ent,
            ...
            fixtures,
            physics);
        _physics.SetCollisionLayer(ent,
            fixture.Key,
            fixture.Value,
        ...
        _container.AttachParentToContainerOrGrid((ent,
            xform)); // Items animated inside inventory now exit, they can't be picked up and so can't escape otherwise
