...
public sealed partial class HungerComponent : Component
{
    ...
    /// </summary>
    [DataField("hungerThresholdDecayModifiers",
    ...
    /// <summary>
    /// Goobstation
    /// Starting hunger value the entity should be at, if set then it overrides the default hunger value randomization
    /// behaviour.
    /// </summary>
    [DataField] [ViewVariables(VVAccess.ReadOnly)]
    ...
    /// <summary>
    /// A dictionary relating HungerThreshold to the amount of <see cref="HungerSystem.GetHunger">current hunger</see> needed
    /// for each one
    /// </summary>
