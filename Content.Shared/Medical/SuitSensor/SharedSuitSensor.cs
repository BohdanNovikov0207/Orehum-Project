...
public sealed class SuitSensorStatus
{
    ...
    public SuitSensorStatus(NetEntity ownerUid,
    ...
    public float? DamagePercentage => TotalDamageThreshold == null || TotalDamage == null
        ? null
        : TotalDamage / (float) TotalDamageThreshold;
}
