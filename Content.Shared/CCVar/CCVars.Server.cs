...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> ServerId =
        CVarDef.Create("server.id", "OrehumProject", CVar.REPLICATED | CVar.SERVER); // if ur a fork of goob pls change this thanks :)
    ...
    public static readonly CVarDef<string> ServerLobbyName =
        CVarDef.Create("server.lobby_name", "Orehum Project", CVar.REPLICATED | CVar.SERVER);
