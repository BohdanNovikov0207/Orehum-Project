...
public sealed partial class CCVars
{
    ...
    /// If a whitelists conditions to be active fail (for example player count), the next whitelist will be used instead. If no
    /// whitelist is valid, the player will be allowed to connect.
    /// </summary>
