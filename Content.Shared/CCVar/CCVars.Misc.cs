...
public sealed partial class CCVars
{
    ...
    /// Disabled: Cloning has full biomass cost and reclaimer can reclaim corpses with souls. (Playtested and balanced for
    /// MRP+).
    /// </summary>
    ...
    /// Used in conjunction with <see cref="PlaytimeMinutesToday" /> to track how long the player has been playing for the
    /// given day.
    /// </summary>
