...
public sealed partial class CCVars
{
    ...
    /// <summary>
    /// The token used to authenticate with the admin API. Leave empty to disable the admin API. This is a secret! Do not
    /// share!
    /// </summary>
    ...
    /// <summary>
    /// The amount of days before the note starts fading. It will slowly lose opacity until it reaches stale. Set to 0 to
    /// disable.
    /// </summary>
    ...
    /// <summary>
    /// The amount of days before the note completely fades, and can only be seen by admins if they press "see more notes". Set
    /// to 0
    ...
    /// <summary>
    /// If true, will reset the last time the player has read the rules. This will mean on their next login they will be shown
    /// the rules again.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether admins count towards the total playercount when determining whether the server is over
    /// <see cref="SoftMaxPlayers" />
