...
public sealed partial class CCVars
{
    ...
    /// <summary>
    /// The flags to use in the request to IPIntel, please look here for more info.
    /// https://getipintel.net/free-proxy-vpn-tor-detection-api/#optional_settings
    /// Note: Some flags may increase the chances of false positives and request time. The default should be fine for most
    /// servers.
    /// </summary>
    ...
    /// <summary>
    /// If true, contraband examination is only possible while wearing an item with `ShowContrabandDetailsComponent`. Requires
    /// `ContrabandExamine` to be true as well.
    /// </summary>
