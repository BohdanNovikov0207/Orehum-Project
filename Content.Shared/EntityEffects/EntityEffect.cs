...
/// <summary>
/// Entity effects describe behavior that occurs on different kinds of triggers, e.g. when a reagent is ingested and
/// metabolized by some
...
/// If a trigger wants to include more info (e.g. the quantity of the chemical triggering the effect), it can be extended
/// (see EntityEffectReagentArgs).
/// </summary>
