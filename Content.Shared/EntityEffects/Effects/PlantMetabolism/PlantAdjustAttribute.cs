...
public abstract partial class PlantAdjustAttribute<T> : EventEntityEffect<T> where T : PlantAdjustAttribute<T>
{
    ...
    /// <summary>
    /// Whether the attribute in question is a good thing. Used for guidebook descriptions to determine the color of the
    /// number.
    /// </summary>
    [DataField]
    ...
    protected override string? ReagentEffectGuidebookText(IPrototypeManager prototype, IEntitySystemManager entSys)
    {
        ...
        if (GuidebookIsAttributePositive ^ (Amount < 0.0))
            ...
            color = "red";
        return Loc.GetString("reagent-effect-guidebook-plant-attribute",
