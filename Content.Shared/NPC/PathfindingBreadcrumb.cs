...
public struct PathfindingBreadcrumb : IEquatable<PathfindingBreadcrumb>
{
    ...
    /// The actual coordinates require using <see cref="SharedPathfindingSystem.ChunkSize" /> and
    /// <see cref="SharedPathfindingSystem.SubStep" />
    /// </summary>
    ...
    public PathfindingBreadcrumb(Vector2i coordinates,
        int layer,
        int mask,
        float damage,
    ...
    /// </summary>
    public bool Equivalent(PathfindingBreadcrumb other) => Data.Equals(other.Data);

    public bool Equals(PathfindingBreadcrumb other) => Coordinates.Equals(other.Coordinates) && Data.Equals(other.Data);

    public override bool Equals(object? obj) => obj is PathfindingBreadcrumb other && Equals(other);

    public override int GetHashCode() => HashCode.Combine(Coordinates, Data);
}
...
public struct PathfindingData : IEquatable<PathfindingData>
{
    ...
    public bool IsEquivalent(PathfindingData other) =>
        CollisionLayer.Equals(other.CollisionLayer) &&
    ...
    public override bool Equals(object? obj) => obj is PathfindingData other && Equals(other);

    public override int GetHashCode() => HashCode.Combine((int) Flags, CollisionLayer, CollisionMask);
}
