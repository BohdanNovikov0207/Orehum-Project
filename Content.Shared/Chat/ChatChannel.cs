...
public enum ChatChannel :
    uint // Goobstation - Starlight collective mind port // surely changing the ushort to uint won't break anything :clueless:
{
    None = 0,
    ...
    /// </summary>
    IC = Local | Whisper | Radio | Dead | Emotes | Damage | Visual | Telepathic | CollectiveMind |
         Notifications, // Goobstation - Starlight collective mind port
