...
/// </summary>
/// <remarks>
/// If an entity with a <see cref="PayloadTriggerComponent" /> is installed into a an entity with a
/// <see
///     cref="PayloadCaseComponent" />
/// , the trigger will grant components to the case-entity. If the case entity is
