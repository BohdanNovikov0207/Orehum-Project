...
public sealed class MarkingManager
{
        ...
        string species)
    {
        ...
        foreach (var (key, marking) in MarkingsByCategory(category))
        {
            ...
            if ((markingPoints.OnlyWhitelisted || markingPoints.Points[category].OnlyWhitelisted) &&
    ...
    public bool CanBeApplied(string species,
        Sex sex,
    ...
    public bool MustMatchSkin(string species,
