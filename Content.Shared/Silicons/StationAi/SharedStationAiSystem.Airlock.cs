...
public abstract partial class SharedStationAiSystem
{
    ...
    private void OnAirlockBolt(EntityUid ent, DoorBoltComponent component, StationAiBoltEvent args)
    {
        ...
        var setResult = _doors.TrySetBoltDown((ent, component), args.Bolted, args.User, true);
        if (!setResult)
            ShowDeviceNotRespondingPopup(args.User);
    }
    ...
    private void OnAirlockEmergencyAccess(EntityUid ent, AirlockComponent component, StationAiEmergencyAccessEvent args)
    {
        ...
        _airlocks.SetEmergencyAccess((ent, component), args.EmergencyAccess, args.User, true);
    }

    /// <summary>
    /// Attempts to electrify the door. If wire was cut (AI or for one of power-wires) or its not powered - notifies AI and
    /// does nothing.
    /// </summary>
