...
public sealed partial class StationAiCustomizationComponent : Component
{
    ...
    public Dictionary<ProtoId<StationAiCustomizationGroupPrototype>, ProtoId<StationAiCustomizationPrototype>>
        ProtoIds = new();
}
...
public sealed class StationAiCustomizationMessage : BoundUserInterfaceMessage
{
    ...
    public StationAiCustomizationMessage(ProtoId<StationAiCustomizationGroupPrototype> groupProtoId,
