...
public abstract partial class SharedStationAiSystem
{
    ...
    private void InitializeLight() => SubscribeLocalEvent<ItemTogglePointLightComponent, StationAiLightEvent>(OnLight);

    private void OnLight(EntityUid ent, ItemTogglePointLightComponent component, StationAiLightEvent args)
    {
        if (args.Enabled)
            _toggles.TryActivate(ent, args.User);
        else
            _toggles.TryDeactivate(ent, args.User);
    }
}
