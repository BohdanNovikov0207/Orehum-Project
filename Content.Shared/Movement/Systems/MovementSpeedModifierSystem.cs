...
public sealed class MovementSpeedModifierSystem : EntitySystem
{
    ...
    public void ChangeBaseSpeed(EntityUid uid,
        float baseWalkSpeed,
    ...
    public void ChangeBaseFriction(EntityUid uid,
        float friction,
...
public sealed class RefreshMovementSpeedModifiersEvent : EntityEventArgs, IInventoryRelayEvent
{
    ...
    public void ModifySpeed(float mod, bool bypassImmunity = false) => ModifySpeed(mod, mod, bypassImmunity);
}
...
public record struct RefreshWeightlessModifiersEvent
{
    ...
    public void ModifyAcceleration(float modifier) => ModifyAcceleration(modifier, modifier);
}
