...
public sealed class MovementModStatusSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<MovementModStatusEffectComponent,
            StatusEffectRelayedEvent<RefreshMovementSpeedModifiersEvent>>(OnRefreshRelay);
        SubscribeLocalEvent<FrictionStatusEffectComponent, StatusEffectRemovedEvent>(OnFrictionStatusEffectRemoved);
        SubscribeLocalEvent<FrictionStatusEffectComponent, StatusEffectRelayedEvent<RefreshFrictionModifiersEvent>>(
            OnRefreshFrictionStatus);
        SubscribeLocalEvent<FrictionStatusEffectComponent, StatusEffectRelayedEvent<TileFrictionEvent>>(
            OnRefreshTileFrictionStatus);
    }

    private void
        OnMovementModRemoved(Entity<MovementModStatusEffectComponent> ent, ref StatusEffectRemovedEvent args) =>
        TryUpdateMovementStatus(args.Target, (ent, ent), 1f);

    private void OnFrictionStatusEffectRemoved(Entity<FrictionStatusEffectComponent> entity,
        ref StatusEffectRemovedEvent args) => TrySetFrictionStatus(entity!, 1f, args.Target);
    ...
    private void OnRefreshFrictionStatus(Entity<FrictionStatusEffectComponent> ent,
        ref StatusEffectRelayedEvent<RefreshFrictionModifiersEvent> args)
    {
        var ev = args.Args;
    ...
    private void OnRefreshTileFrictionStatus(Entity<FrictionStatusEffectComponent> ent,
        ref StatusEffectRelayedEvent<TileFrictionEvent> args)
    {
        var ev = args.Args;
    ...
    public bool TryAddMovementSpeedModDuration(
        ...
        TryAddMovementSpeedModDuration(uid, effectProtoId, duration, speedModifier, speedModifier);
    ...
    public bool TryAddMovementSpeedModDuration(
        ...
        _status.TryAddStatusEffectDuration(uid, effectProtoId, out var status, duration)
    ...
    public bool TryUpdateMovementSpeedModDuration(
        ...
        TryUpdateMovementSpeedModDuration(uid, effectProtoId, duration, speedModifier, speedModifier);
    ...
    public bool TryUpdateMovementSpeedModDuration(
        ...
        _status.TryUpdateStatusEffectDuration(uid, effectProtoId, out var status, duration)
        && TryUpdateMovementStatus(uid, status!.Value, walkSpeedModifier, sprintSpeedModifier);
    ...
    public bool TryUpdateMovementStatus(
        ...
        TryUpdateMovementStatus(uid, status, speedModifier, speedModifier);
    ...
    public bool TryAddFrictionModDuration(
        ...
        TryAddFrictionModDuration(uid, duration, friction, friction);
    ...
    public bool TryAddFrictionModDuration(
        ...
        _status.TryAddStatusEffectDuration(uid, StatusEffectFriction, out var status, duration)
    ...
    public bool TryUpdateFrictionModDuration(
        ...
        TryUpdateFrictionModDuration(uid, duration, friction, friction);
    ...
    public bool TryUpdateFrictionModDuration(
        ...
        _status.TryUpdateStatusEffectDuration(uid, StatusEffectFriction, out var status, duration)
        && TrySetFrictionStatus(status.Value, friction, acceleration, uid);
    ...
    private bool
        TrySetFrictionStatus(Entity<FrictionStatusEffectComponent?> status, float friction, EntityUid entity) =>
        TrySetFrictionStatus(status, friction, friction, entity);
    ...
    /// <param name="entity">The entity the status effect is attached to that we need to refresh.</param>
    private bool TrySetFrictionStatus(Entity<FrictionStatusEffectComponent?> status,
        float friction,
        float acceleration,
        EntityUid entity)
    {
