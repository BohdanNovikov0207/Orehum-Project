...
public sealed partial class ComplexAction : InteractionAction
{
    ...
    public override bool IsAllowed(InteractionArgs args, InteractionVerbPrototype proto, VerbDependencies deps) =>
        Delegate(act => act.IsAllowed(args, proto, deps));

    public override bool CanPerform(InteractionArgs args,
        InteractionVerbPrototype proto,
        bool beforeDelay,
        VerbDependencies deps) => Delegate(act => act.CanPerform(args, proto, beforeDelay, deps));

    public override bool Perform(InteractionArgs args, InteractionVerbPrototype proto, VerbDependencies deps) =>
        Delegate(act => act.Perform(args, proto, deps));
}
