...
/// Similarly to interaction verb locales, {$user}, {$target} amd {$used} arguments are passed to the locales retrieved by
/// this action.
/// </summary>
[Serializable]
public sealed partial class ChatMessageAction : InteractionAction
{
    ...
    public override bool CanPerform(InteractionArgs args,
        ...
        bool beforeDelay,
        VerbDependencies deps) => deps.EntMan.System<ActionBlockerSystem>().CanSpeak(GetSpeaker(args));
    ...
    public override bool Perform(InteractionArgs args, InteractionVerbPrototype proto, VerbDependencies deps)
    {
        ...
        {
            Logger.GetSawmill("action.chat_message")
