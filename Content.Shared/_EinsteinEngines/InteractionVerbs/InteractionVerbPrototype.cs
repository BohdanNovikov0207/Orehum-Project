...
public sealed partial class InteractionVerbPrototype : IPrototype, IInheritingPrototype
{
    ...
    /// The user's advantage will never exceed this range. This is applied after <see cref="ContestAdvantageRange" /> is
    /// checked.
    /// </summary>
    /// <returns></returns>
    [DataField]
    ...
    /// <summary>
    /// Cooldown between uses of this verb. Applied per user or per user-target pair (see <see cref="GlobalCooldown" />) and
    /// before the do-after.
    /// </summary>
    [DataField]
    ...
    /// <summary>
    /// If true, this action will be hidden if the <see cref="Requirement" /> does not pass its IsMet check. Otherwise it will
    /// be shown, but disabled.
    /// </summary>
    ...
    /// <summary>
    /// If true, this action will be hidden if the <see cref="Action" /> does not pass its IsAllowed check. Otherwise it will
    /// be shown, but disabled.
    /// </summary>
    [DataField]
    ...
    public partial class EffectSpecifier
    {
        ...
        [DataField]
        public AudioParams SoundParams = new()
        {
            Variation = 0.1f,
        };
