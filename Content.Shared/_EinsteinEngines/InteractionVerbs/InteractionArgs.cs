...
public sealed class InteractionArgs
{
    ...
    /// </summary>
    /// <remarks>
    /// Can be null, which means it's not calculated yet. That can happen before the user attempts to perform the
    /// verb.
    /// </remarks>
    ...
    public InteractionArgs(EntityUid user,
        EntityUid target,
        EntityUid? used,
        bool canAccess,
        bool canInteract,
    ...
    public InteractionArgs(InteractionArgs other) : this(other.User,
        other.Target,
        other.Used,
        other.CanAccess,
        other.CanInteract,
    ...
    /// </remarks>
    public Dictionary<string, object> Blackboard => _blackboardField ??= new Dictionary<string, object>(3);

    public static InteractionArgs From<T>(GetVerbsEvent<T> ev) where T : Verb => new(ev.User,
        ev.Target,
        ev.Using,
        ev.CanAccess,
        ev.CanInteract,
