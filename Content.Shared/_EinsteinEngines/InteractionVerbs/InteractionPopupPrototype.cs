...
public sealed class InteractionPopupPrototype : IPrototype
{
    ...
    /// <summary>
    /// If true, entities who cannot directly see the popup target will not chat log. Only has effect if
    /// <see cref="LogPopup" /> is true.
    /// </summary>
    [DataField]
