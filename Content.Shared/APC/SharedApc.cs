...
public sealed class ApcBoundInterfaceState : BoundUserInterfaceState, IEquatable<ApcBoundInterfaceState>
{
    ...
    public override bool Equals(object? obj) =>
        ReferenceEquals(this, obj) || obj is ApcBoundInterfaceState other && Equals(other);

    public override int GetHashCode() => HashCode.Combine(MainBreaker, Power, (int) ApcExternalPower, Charge);
}
