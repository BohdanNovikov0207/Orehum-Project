...
public abstract class SharedItemSwitchSystem : EntitySystem
{
    ...
    private void OnUseInHand(Entity<ItemSwitchComponent> ent, ref UseInHandEvent args)
    {
        ...
        Switch((ent, comp), Next(ent), args.User, comp.Predictable);
    }
    ...
    private void OnActivate(Entity<ItemSwitchComponent> ent, ref ActivateInWorldEvent args)
    {
        ...
        Switch((ent.Owner, ent.Comp), Next(ent), args.User, ent.Comp.Predictable);
    }
    ...
    public bool Switch(Entity<ItemSwitchComponent?> ent, string? key, EntityUid? user = null, bool predicted = true)
    {
            ...
            _container.TryGetContainingContainer((uid, null, null), out var container))
        {
            ...
            else if (HasComp<InventoryComponent>(container.Owner) && _item.GetSizePrototype(item.Size) >
                     _item.GetSizePrototype(InventorySystem.PocketableItemSize))
            {
