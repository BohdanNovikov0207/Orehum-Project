...
public sealed partial class ProjectileComponent : Component
{
    ...
    /// <summary>
    /// Whether this projectile will only collide with entities if it was shot from a gun (if <see cref="Weapon" /> is not
    /// null).
    /// </summary>
    [DataField]
    ...
    /// <summary>
    /// When a projectile has this threshold set, it will continue to penetrate entities until the damage dealt reaches this
    /// threshold.
    /// </summary>
    [DataField]
