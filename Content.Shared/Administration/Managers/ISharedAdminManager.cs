...
public interface ISharedAdminManager
{
    ...
    bool IsAdmin(EntityUid uid, bool includeDeAdmin = false) => GetAdminData(uid, includeDeAdmin) != null;
    ...
    /// </param>
    /// <returns>true if the player is an admin, false otherwise.</returns>
    bool IsAdmin(ICommonSession session, bool includeDeAdmin = false) => GetAdminData(session, includeDeAdmin) != null;
}
