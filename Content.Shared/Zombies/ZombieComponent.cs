...
public sealed partial class ZombieComponent : Component
{
    ...
    public float BaseZombieInfectionChance = 1.00f;
    ...
    /// </remarks>
    [DataField]
    public ProtoId<LanguagePrototype>
        ForcedLanguage = "Xeno"; // Xeno until we make a zombie/ignorant language that is unobtainable.
    ...
    {
        DamageDict = new Dictionary<string, FixedPoint2>() ///Changed to be higher for goob
        {
            { "Blunt", -25 },
            { "Slash", -25 },
            { "Piercing", -25 },
    ...
    [ViewVariables(VVAccess.ReadWrite)]
    public float ZombieMovementSpeedDebuff = 0.95f;
