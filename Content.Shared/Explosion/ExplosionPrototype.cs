...
public sealed class ExplosionPrototype : IPrototype
{
    ...
    public SoundSpecifier SmallSoundFar =
        new SoundCollectionSpecifier("ExplosionSmallFar", AudioParams.Default.WithVolume(2f));
    ...
    public float TileBreakChance(float intensity)
    {
        ...
        var slope = (_tileBreakChance[i] - _tileBreakChance[i - 1]) /
                    (_tileBreakIntensity[i] - _tileBreakIntensity[i - 1]);
