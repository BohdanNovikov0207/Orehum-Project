...
{
    public static float CelsiusToKelvin(float celsius) => celsius + PhysicalConstants.ZERO_CELCIUS;

    public static float CelsiusToFahrenheit(float celsius) => celsius * 9 / 5 + 32;

    public static float KelvinToCelsius(float kelvin) => kelvin - PhysicalConstants.ZERO_CELCIUS;
