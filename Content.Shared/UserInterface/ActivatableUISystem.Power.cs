...
public sealed partial class ActivatableUISystem
{
    ...
    private void OnBatteryOpened(EntityUid uid,
    ...
    private void OnBatteryClosed(EntityUid uid,
        ActivatableUIRequiresPowerCellComponent component,
    ...
    /// </summary>
    public void CheckUsage(EntityUid uid,
    ...
    private void OnBatteryOpenAttempt(EntityUid uid,
        ActivatableUIRequiresPowerCellComponent component,
