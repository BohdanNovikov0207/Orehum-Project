...
public sealed class ActionBlockerSystem : EntitySystem
{
    ...
    public bool CanMove(EntityUid uid, InputMoverComponent? component = null) =>
        Resolve(uid, ref component, false) && component.CanMove;
    ...
    /// This is used to gate manipulation to general humanoids. If a mouse shouldn't be able to do something, then it's
    /// complex.
    /// </summary>
    public bool CanComplexInteract(EntityUid user) => _complexInteractionQuery.HasComp(user);
