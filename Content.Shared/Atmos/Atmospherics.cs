...
public static class Atmospherics
{
    ...
    /// <summary>
    /// The amount of pressure damage someone takes is equal to ((pressure / HAZARD_HIGH_PRESSURE) -
    /// 1)*PRESSURE_DAMAGE_COEFFICIENT,
    ...
    /// </summary>
    public static Dictionary<Gas, string> GasAbbreviations = new()
    {
    ...
    public const float
        Tmax = 262144000000; // 1/64 of max safe integer, any values above will result in a ~0.03K epsilon // Goobstation - no
    ...
    /// This is used in fix atmos freezer markers to ensure the air is at the correct atmospheric pressure while still being
    /// cold.
    /// </summary>
