...
public static class AtmosDirectionHelpers
{
    ...
    public static AtmosDirection ToAtmosDirectionCardinal(this Angle angle) =>
        angle.GetCardinalDir().ToAtmosDirection();
    ...
    /// <param name="angle"></param>
    /// <returns></returns>
    public static AtmosDirection ToAtmosDirection(this Angle angle) => angle.GetDir().ToAtmosDirection();
    ...
    public static int ToIndex(this AtmosDirection direction) =>
        ...
        BitOperations.Log2((uint) direction);

    public static AtmosDirection WithFlag(this AtmosDirection direction, AtmosDirection other) => direction | other;

    public static AtmosDirection WithoutFlag(this AtmosDirection direction, AtmosDirection other) => direction & ~other;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsFlagSet(this AtmosDirection direction, AtmosDirection other) => (direction & other) == other;
    ...
    public static Vector2i Offset(this Vector2i pos, AtmosDirection dir) => pos + dir.CardinalToIntVec();
}
