...
public abstract class SharedGasThermoMachineSystem : EntitySystem
{
    ...
    public bool IsHeater(GasThermoMachineComponent comp) => comp.Cp >= 0;

    private void OnToggleMessage(EntityUid uid,
    ...
    private void OnChangeTemperature(EntityUid uid,
        GasThermoMachineComponent thermoMachine,
        GasThermomachineChangeTemperatureMessage args)
    {
        ...
        _adminLogger.Add(LogType.AtmosTemperatureChanged,
