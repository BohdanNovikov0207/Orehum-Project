...
public abstract class SharedGasCanisterSystem : EntitySystem
{
    ...
    private void OnCanisterContainerModified(EntityUid uid,
    ...
    private static string GetContainedGasesString(Entity<GasCanisterComponent> canister) =>
        string.Join(", ", canister.Comp.Air);

    private void OnHoldingTankEjectMessage(EntityUid uid,
        ...
        GasCanisterHoldingTankEjectMessage args)
    {
        ...
        _slots.TryEjectToHands(uid, canister.GasTankSlot, args.Actor, true);

        if (canister.ReleaseValve)
            AdminLogger.Add(LogType.CanisterTankEjected,
                LogImpact.High,
    ...
    private void OnCanisterChangeReleasePressure(EntityUid uid,
        GasCanisterComponent canister,
        GasCanisterChangeReleasePressureMessage args)
    {
        ...
        AdminLogger.Add(LogType.CanisterPressure,
            LogImpact.Medium,
    ...
    private void OnCanisterChangeReleaseValve(EntityUid uid,
        GasCanisterComponent canister,
        GasCanisterChangeReleaseValveMessage args)
    {
        ...
        AdminLogger.Add(LogType.CanisterValve,
            impact,
    ...
    private void OnCanisterInsertAttempt(EntityUid uid,
        GasCanisterComponent component,
    ...
    protected abstract void DirtyUI(EntityUid uid,
