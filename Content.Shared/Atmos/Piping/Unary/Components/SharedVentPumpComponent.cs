...
public sealed class GasVentPumpData : IAtmosDeviceData
{
    ...
    public static GasVentPumpData FilterModePreset = new()
    {
        Enabled = true,
    ...
    public static GasVentPumpData FillModePreset = new()
    {
        Enabled = true,
        Dirty = true,
        PumpDirection = VentPumpDirection.Releasing,
    ...
    public static GasVentPumpData PanicModePreset = new()
    {
        Enabled = false,
        Dirty = true,
        PumpDirection = VentPumpDirection.Releasing,
    ...
    public static GasVentPumpData ReplaceModePreset = new()
    {
        Enabled = false,
        IgnoreAlarms = true,
        Dirty = true,
