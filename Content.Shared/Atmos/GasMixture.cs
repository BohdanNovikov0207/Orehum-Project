    ...
    IEnumerable<(Gas gas, float moles)>
{
    ...
    public static GasMixture SpaceGas => new()
        { Volume = Atmospherics.CellVolume, Temperature = Atmospherics.TCMB, Immutable = true };
    ...
    IEnumerator<(Gas gas, float moles)> IEnumerable<(Gas gas, float moles)>.GetEnumerator() => GetEnumerator();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void MarkImmutable() => Immutable = true;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public float GetMoles(int gasId) => Moles[gasId];

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public float GetMoles(Gas gas) => GetMoles((int) gas);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void SetMoles(Gas gas, float quantity) => SetMoles((int) gas, quantity);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void AdjustMoles(Gas gas, float moles) => AdjustMoles((int) gas, moles);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GasMixture Remove(float amount) => RemoveRatio(amount / TotalMoles);
    ...
    public GasMixture RemoveVolume(float vol) => RemoveRatio(vol / Volume);
    ...
    private GasEnumerator GetEnumerator() => new(this);
    ...
    public struct GasEnumerator(GasMixture mixture) : IEnumerator<(Gas gas, float moles)>
    {
        ...
        public bool MoveNext() => ++_idx < Atmospherics.TotalNumberOfGases;
