...
public sealed class SlowOnDamageSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ClothingSlowOnDamageModifierComponent, InventoryRelayedEvent<ModifySlowOnDamageSpeedEvent>>(
            OnModifySpeed);
    ...
    private void OnModifySpeed(Entity<ClothingSlowOnDamageModifierComponent> ent,
    ...
    {
        var msg = Loc.GetString("slow-on-damage-modifier-examine",
            ("mod", Math.Round(100 - ent.Comp.Modifier * 100))); // Goob edit
        args.PushMarkup(msg);
    }
    ...
    private void
        OnGotUnequipped(Entity<ClothingSlowOnDamageModifierComponent> ent, ref ClothingGotUnequippedEvent args) =>
        _movementSpeedModifierSystem.RefreshMovementSpeedModifiers(args.Wearer);
