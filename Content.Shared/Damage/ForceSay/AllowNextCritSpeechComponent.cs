...
/// This component is either removed in the <see cref="MobStateSystem" /> speech attempt check, or after
/// <see cref="Timeout" />
/// has passed. This is to allow a player-submitted forced message in the case of <see cref="DamageForceSayComponent" />,
/// while also ensuring that it isn't valid forever. It has to work this way, because the server is not a keylogger and
/// doesn't
