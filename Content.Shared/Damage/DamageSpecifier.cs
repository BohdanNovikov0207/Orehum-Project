...
public sealed partial class DamageSpecifier : IEquatable<DamageSpecifier>
{
    ...
    public override string ToString() =>
        "DamageSpecifier(" + string.Join("; ", DamageDict.Select(x => x.Key + ":" + x.Value)) + ")";
    ...
    public static DamageSpecifier ApplyModifierSet(DamageSpecifier damageSpec, DamageModifierSet modifierSet)
    {
        ...
        DamageSpecifier newDamage = new(damageSpec.ArmorPenetration,
            damageSpec.PartDamageVariation,
            damageSpec.WoundSeverityMultipliers); // Goob edit
        ...
        Dictionary<string, FixedPoint2> severityMultipliers)
    {
        ...
        WoundSeverityMultipliers = new Dictionary<string, FixedPoint2>(severityMultipliers);
    }
    ...
    public DamageSpecifier(DamageSpecifier damageSpec)
    {
        ...
        WoundSeverityMultipliers = new Dictionary<string, FixedPoint2>(damageSpec.WoundSeverityMultipliers);
    }
    ...
    /// <summary>
    /// Constructor that takes a single damage group prototype and a damage value. The value is divided between members of the
    /// damage group.
    /// </summary>
