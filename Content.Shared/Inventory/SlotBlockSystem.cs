...
public sealed class SlotBlockSystem : EntitySystem
{
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<SlotBlockComponent, InventoryRelayedEvent<IsUnequippingTargetAttemptEvent>>(
            OnUnequipAttempt);
    }

    private void OnEquipAttempt(Entity<SlotBlockComponent> ent,
    ...
    private void OnUnequipAttempt(Entity<SlotBlockComponent> ent,
