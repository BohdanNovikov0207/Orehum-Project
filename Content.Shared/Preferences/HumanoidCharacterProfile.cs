...
public sealed partial class HumanoidCharacterProfile : ICharacterProfile
{
    ...
    public ProtoId<BarkPrototype> BarkVoice { get; set; } =
        SharedHumanoidAppearanceSystem.DefaultBarkVoice; // Goob Station - Barks
    ...
    public bool MemberwiseEquals(ICharacterProfile maybeOther)
    {
        ...
        if (Height != other.Height)
            return false; // Goobstation: port EE height/width sliders
        if (Width != other.Width)
            return false; // Goobstation: port EE height/width sliders
        if (BarkVoice != other.BarkVoice)
            return false; // Goob Station - Barks
    ...
    /// </summary>
    /// <param name="species">
    /// The species to use in this default profile. The default species is
    /// <see cref="SharedHumanoidAppearanceSystem.DefaultSpecies" />.
    /// </param>
    ...
    public static HumanoidCharacterProfile RandomWithSpecies(string? species = null)
    {
        ...
        if (prototypeManager.TryIndex<SpeciesPrototype>(species, out var speciesPrototype))
        {
            ...
            height = random.NextFloat(speciesPrototype.MinHeight,
                speciesPrototype.MaxHeight); // Goobstation: port EE height/width sliders
            width = random.NextFloat(speciesPrototype.MinWidth,
                speciesPrototype.MaxWidth); // Goobstation: port EE height/width sliders
        }
    ...
    // Goob Station - Barks Start
    public HumanoidCharacterProfile WithBarkVoice(BarkPrototype barkVoice) => new(this) { BarkVoice = barkVoice };
    // Goob Station - Barks End
    ...
    /// </summary>
    public List<ProtoId<TraitPrototype>> GetValidTraits(IEnumerable<ProtoId<TraitPrototype>> traits,
        IPrototypeManager protoManager)
    {
    ...
    public override bool Equals(object? obj) => obj is HumanoidCharacterProfile other && Equals(other);
    ...
    public void SetLoadout(RoleLoadout loadout) => _loadouts[loadout.Role.Id] = loadout;
    ...
    public RoleLoadout GetLoadoutOrDefault(string id,
    ...
    public HumanoidCharacterProfile Clone() => new(this);
}
