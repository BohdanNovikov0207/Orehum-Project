...
/// <summary>
///     <para>
///     <c>ItemMapperComponent</c> is a <see cref="Component" /> that maps string labels to an
///     <see cref="Content.Shared.Whitelist.EntityWhitelist" /> of elements. Useful primarily  for visualization.
///     </para>
///     <para>
///     To define a mapping, create a <c>mapLayers</c> map in configuration <c>ItemMapper</c> component and with
///     <see cref="MapLayers" /> mapping.
///     Each map layer maps layer name to an <see cref="Content.Shared.Whitelist.EntityWhitelist" />, plus special
///     modifiers for min and max item count.
///     Min and max count are useful when you need to visualize a certain number of items, for example, to display one,
///     two, three, or more items.
///     </para>
///     <para>
///     If you need a more straightforward way to change appearance where only variable is how many items, rather than
///     which items
...
/// </code>
///     To map <c>Powerdrill</c>
///     <b>
///         <see cref="Content.Shared.Tag.TagComponent" />
///     </b>
///     to the given example, we need the following code.
///     <code>
/// - type: ItemMapper
///   mapLayers:
///     drill:
...
/// #... to be continued
/// </code>
///     To map <c>Lightbulb</c>
///     <b>
///         <see cref="Component" />
///     </b>
///     (not tag) to two different layers (for one and two light bulbs, respectively)
///     <code>
/// #... to be continued
///     lightbulb1:
///       minCount: 1
...
///         - Lightbulb
/// </code>
///     The min count will ensure that <c>lightbulb1</c> layer is only displayed when one or more light bulbs are in the
///     belt.
