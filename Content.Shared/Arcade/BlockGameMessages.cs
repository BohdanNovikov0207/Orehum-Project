...
public static class BlockGameMessages
{
    ...
    public sealed class BlockGameGameOverScreenMessage : BlockGameSetScreenMessage
    {
        ...
        public BlockGameGameOverScreenMessage(int finalScore, int? localPlacement, int? globalPlacement) : base(
            BlockGameScreen.Gameover)
        {
    ...
    public sealed class BlockGameHighScoreUpdateMessage : BoundUserInterfaceMessage
    {
        ...
        public BlockGameHighScoreUpdateMessage(List<HighScoreEntry> localHighscores,
