...
{
    public static BlockGameBlock ToBlockGameBlock(this Vector2i vector2,
        BlockGameBlock.BlockGameBlockColor gameBlockColor) => new(vector2, gameBlockColor);

    public static Vector2i AddToX(this Vector2i vector2, int amount) => new(vector2.X + amount, vector2.Y);

    public static Vector2i AddToY(this Vector2i vector2, int amount) => new(vector2.X, vector2.Y + amount);

    public static Vector2i Rotate90DegreesAsOffset(this Vector2i vector) => new(-vector.Y, vector.X);
}
