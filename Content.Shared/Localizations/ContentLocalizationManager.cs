...
public sealed class ContentLocalizationManager
{
    ...
    /// </summary>
    public static string FormatDirection(Direction dir) => Loc.GetString($"zzzz-fmt-direction-{dir.ToString()}");
    ...
    private static ILocValue FormatPressure(LocArgs args) => FormatUnitsGeneric(args, "zzzz-fmt-pressure");

    private static ILocValue FormatPowerWatts(LocArgs args) => FormatUnitsGeneric(args, "zzzz-fmt-power-watts");

    private static ILocValue FormatPowerJoules(LocArgs args) => FormatUnitsGeneric(args, "zzzz-fmt-power-joules");
