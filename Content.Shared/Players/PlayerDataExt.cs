...
public static class PlayerDataExt
{
    ...
    /// </summary>
    public static ContentPlayerData? ContentData(this SessionData data) => (ContentPlayerData?) data.ContentDataUncast;

    /// <summary>
    /// Gets the correctly cast instance of content player data from an engine player data storage.
    /// </summary>
    public static ContentPlayerData? ContentData(this ICommonSession session) => session.Data.ContentData();
