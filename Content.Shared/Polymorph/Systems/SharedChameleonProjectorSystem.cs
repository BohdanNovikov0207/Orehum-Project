...
public abstract class SharedChameleonProjectorSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ChameleonDisguiseComponent, InteractHandEvent>(OnDisguiseInteractHand,
    ...
    private void OnDisguisedInserted(Entity<ChameleonDisguisedComponent> ent,
    ...
    private void OnDisguiseInsertAttempt(Entity<ChameleonDisguiseComponent> ent,
    ...
    public void Disguise(Entity<ChameleonProjectorComponent> ent, EntityUid user, EntityUid entity)
    {
        ...
        _actions.AddAction(user, ref proj.NoRotActionEntity, proj.NoRotAction, ent);
        _actions.AddAction(user, ref proj.AnchorActionEntity, proj.AnchorAction, ent);
