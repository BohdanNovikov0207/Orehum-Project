...
public sealed class GraphNodeEntitySerializer : ITypeSerializer<IGraphNodeEntity, ValueDataNode>,
    ITypeSerializer<IGraphNodeEntity, MappingDataNode>
{
    public ValidationNode Validate(ISerializationManager serializationManager,
        ...
        serializationManager.ValidateNode<IGraphNodeEntity>(node, context);

    public IGraphNodeEntity Read(ISerializationManager serializationManager,
        MappingDataNode node,
        IDependencyCollection dependencies,
    ...
    public IGraphNodeEntity Read(ISerializationManager serializationManager,
        ...
        ISerializationContext? context = null,
        ISerializationManager.InstantiationDelegate<IGraphNodeEntity>? instanceProvider = null) =>
        new StaticNodeEntity(node.Value);
