...
public sealed partial class WallmountCondition : IConstructionCondition
{
    ...
    public bool Condition(EntityUid user, EntityCoordinates location, Direction direction)
    {
        ...
        var rUserToObj =
            new CollisionRay(userWorldPosition, userToObject.Normalized(), (int) CollisionGroup.Impassable);
        ...
        var rAdjWall = new CollisionRay(objWorldPosition,
        ...
        var adjWallRaycastResults = physics.IntersectRayWithPredicate(
            ...
            rAdjWall,
            0.5f,
            e => e == targetWall.Value.HitEntity || !tagSystem.HasTag(e, WallTag));
