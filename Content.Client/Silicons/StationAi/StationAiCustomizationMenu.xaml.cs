...
public sealed partial class StationAiCustomizationMenu : FancyWindow
{
    ...
    private readonly Dictionary<ProtoId<StationAiCustomizationGroupPrototype>, ButtonGroup> _buttonGroups = new();
    [Dependency] private readonly IEntityManager _entManager = default!;

    private readonly Dictionary<ProtoId<StationAiCustomizationGroupPrototype>, StationAiCustomizationGroupContainer>
    ...
    public StationAiCustomizationMenu(EntityUid owner)
    {
        ...
        foreach (var groupPrototype in groupPrototypes)
        {
            ...
            _groupContainers[groupPrototype] = new StationAiCustomizationGroupContainer(groupPrototype,
                selectedPrototype,
    ...
    public event Action<ProtoId<StationAiCustomizationGroupPrototype>, ProtoId<StationAiCustomizationPrototype>>?
        SendStationAiCustomizationMessageAction;

    public void OnSendStationAiCustomizationMessage(ProtoId<StationAiCustomizationGroupPrototype> groupProtoId,
    ...
    {
        public StationAiCustomizationGroupContainer(StationAiCustomizationGroupPrototype groupPrototype,
    ...
    private sealed class StationAiCustomizationEntryContainer : BoxContainer
    {
        ...
        public StationAiCustomizationEntryContainer(StationAiCustomizationGroupPrototype groupPrototype,
            ...
            StationAiCustomizationMenu menu)
        {
            ...
            if (!string.IsNullOrEmpty(prototype.PreviewKey) &&
