...
public sealed partial class LoadingScreenControl : Control
{
    public static SpriteSpecifier Sprite =
        new SpriteSpecifier.Rsi(new ResPath("/Textures/Mobs/Silicon/Bots/mommi.rsi"), "wiggle");
    ...
    public LoadingScreenControl(IResourceCache resCache)
    {
        ...
        Header.FontOverride =
            resCache.NotoStack2ElectricBoogaloo("/Fonts/NotoSansDisplay/NotoSansDisplay-Bold.ttf", 24);
        Subtext.FontOverride =
            resCache.NotoStack2ElectricBoogaloo("/Fonts/NotoSansDisplay/NotoSansDisplay-Bold.ttf", 12);
