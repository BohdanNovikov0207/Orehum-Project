...
public sealed class FlashOverlay : Overlay
{
    ...
    public FlashOverlay()
    {
        ...
        _configManager.OnValueChanged(CCVars.ReducedMotion, b => { _reducedMotion = b; }, true);
    }
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        if (RequestScreenTexture && ScreenTexture != null)
        {
            ...
            RequestScreenTexture =
                false; // we only need the first frame, so we can stop the request now for performance reasons
        }
