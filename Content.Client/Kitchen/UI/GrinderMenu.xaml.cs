...
public sealed partial class GrinderMenu : FancyWindow
{
    ...
    public void UpdateState(ReagentGrinderInterfaceState state)
    {
        ...
        RefreshContentsDisplay(state.ReagentQuantities,
    ...
    private void RefreshContentsDisplay(IList<ReagentQuantity>? reagents,
        ...
        bool isBeakerAttached)
    {
        ...
        foreach (var entity in containedSolids)
        {
            ...
            var solidItem =
                ChamberContentBox.BoxContents.AddItem(_entityManager.GetComponent<MetaDataComponent>(entity).EntityName,
                    texture);
