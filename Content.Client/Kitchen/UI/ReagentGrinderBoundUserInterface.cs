...
public sealed class ReagentGrinderBoundUserInterface : BoundUserInterface
{
    ...
    public void ToggleAutoMode() => SendMessage(new ReagentGrinderToggleAutoModeMessage());

    public void StartGrinding() => SendMessage(new ReagentGrinderStartMessage(GrinderProgram.Grind));

    public void StartJuicing() => SendMessage(new ReagentGrinderStartMessage(GrinderProgram.Juice));

    public void EjectAll() => SendMessage(new ReagentGrinderEjectChamberAllMessage());

    public void EjectBeaker() => SendMessage(new ItemSlotButtonPressedEvent(SharedReagentGrinder.BeakerSlotId));
