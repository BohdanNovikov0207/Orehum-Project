...
public sealed partial class GasAnalyzerWindow : DefaultWindow
{
    ...
    public void Populate(GasAnalyzerUserMessage msg)
    {
        ...
        if (msg.NodeGasMixes.Length > 1)
        {
            ...
            if (msg.NodeGasMixes.Length == 2)
            {
                ...
                MiddlePanelLabel.Text = Loc.GetString("gas-analyzer-window-tab-title-capitalized",
    ...
    private void GenerateGasDisplay(GasMixEntry gasMix, Control parent)
    {
        ...
        var dataContainer = new BoxContainer
            { Orientation = BoxContainer.LayoutOrientation.Vertical, VerticalExpand = true, Margin = new Thickness(4) };
        ...
        for (var j = 0; j < gasMix.Gases.Length; j++)
        {
            ...
            gasBar.AddEntry(gas.Amount,
                color,
                Loc.GetString("gas-analyzer-window-molarity-percentage-text",
                    ("gasName", gas.Name),
                    ("amount", $"{gas.Amount:0.##}"),
