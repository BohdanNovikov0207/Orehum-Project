...
public sealed partial class AtmosMonitoringConsoleWindow : FancyWindow
{
    ...
    private readonly ProtoId<NavMapBlipPrototype> _gasPipeSensorProtoId = "GasPipeSensor";
    private readonly ProtoId<NavMapBlipPrototype> _navMapConsoleProtoId = "NavMapConsole";

    private readonly EntityUid? _owner;

    private readonly Vector2[] _pipeLayerOffsets = { new(0f, 0f), new(0.25f, 0.25f), new(-0.25f, -0.25f) };
    ...
    public AtmosMonitoringConsoleWindow(AtmosMonitoringConsoleBoundUserInterface userInterface, EntityUid? owner)
    {
        ...
        if (_entManager.TryGetComponent<TransformComponent>(owner, out var xform))
        {
            ...
            msg.TryAddMarkup(Loc.GetString("atmos-monitoring-window-station-name", ("stationName", stationName)),
                out _);
        ...
        AtmosMonitoringConsoleEntry[] atmosNetworks)
    {
        ...
        for (var index = 0; index < atmosNetworks.Length; index++)
        {
    ...
    private void UpdateUIEntry(AtmosMonitoringConsoleEntry data,
        int index,
        Control table,
    ...
    private void UpdateConsoleTable(AtmosMonitoringConsoleComponent console,
        Control table,
    ...
    protected override void FrameUpdate(FrameEventArgs args) => AutoScrollToFocus();

    private void ActivateAutoScrollToFocus() => _autoScrollActive = true;
    ...
    private void OnFocusChanged()
    {
        ...
        for (var index = 0; index < AtmosNetworksTable.ChildCount; index++)
        {
