...
public sealed partial class AtmosMonitoringEntryContainer : BoxContainer
{
    ...
    public void UpdateEntry(AtmosMonitoringConsoleEntry updatedData, bool isFocus)
    {
        ...
        if (!string.IsNullOrEmpty(updatedData.Address))
            NetworkNameLabel.Text = Loc.GetString("atmos-alerts-window-alarm-label",
        ...
        // Update total mol
        TotalMolLabel.Text = Loc.GetString("atmos-alerts-window-total-mol-value",
        ...
        else
        {
            ...
            foreach (var (gas, percent) in updatedData.GasData)
            {
                ...
                var gasAbbreviation =
                    Atmospherics.GasAbbreviations.GetValueOrDefault(gas, Loc.GetString("gas-unknown-abbreviation"));
