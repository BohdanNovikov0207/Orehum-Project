...
public class GameplayState : GameplayStateBase, IMainViewportState
{
    ...
    protected override void Startup()
    {
        ...
        _configurationManager.OnValueChanged(CCVars.HudVersionWatermark,
            show => { _version.Visible = VersionVisible(); },
            true);
        _configurationManager.OnValueChanged(CCVars.ForceClientHudVersionWatermark,
            show => { _version.Visible = VersionVisible(); },
            true);
    ...
    private void ReloadMainScreenValueChange(string _) => ReloadMainScreen();
