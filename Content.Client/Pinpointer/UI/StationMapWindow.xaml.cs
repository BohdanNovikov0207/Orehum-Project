...
public sealed partial class StationMapWindow : FancyWindow
{
    ...
    public void Set(string stationName, EntityUid? mapUid, EntityUid? trackedEntity)
    {
        ...
        if (trackedEntity != null)
            NavMapScreen.TrackedCoordinates.Add(new EntityCoordinates(trackedEntity.Value, Vector2.Zero),
                (true, Color.Cyan));
    ...
    public void OnFilterChanged(string newFilter)
    {
        ...
        {
            button.Visible = string.IsNullOrEmpty(newFilter) || !string.IsNullOrEmpty(button.Label) &&
