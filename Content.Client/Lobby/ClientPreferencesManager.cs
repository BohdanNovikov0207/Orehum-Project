...
public sealed class ClientPreferencesManager : IClientPreferencesManager
{
    ...
    public void SelectCharacter(ICharacterProfile profile) => SelectCharacter(Preferences.IndexOfCharacter(profile));
    ...
    public void UpdateCharacter(ICharacterProfile profile, int slot)
    {
        ...
        Preferences = new PlayerPreferences(characters,
    ...
    public void DeleteCharacter(ICharacterProfile profile) => DeleteCharacter(Preferences.IndexOfCharacter(profile));
