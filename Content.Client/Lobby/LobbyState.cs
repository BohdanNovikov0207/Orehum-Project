...
public sealed class LobbyState : State
{
    ...
    private void OnPatronPerksPressed(BaseButton.ButtonEventArgs obj) => _userInterfaceManager
        .GetUIController<LinkAccountUIController>()
        .TogglePatronPerksWindow();
    ...
    private void OnReadyToggled(BaseButton.ButtonToggledEventArgs args) => SetReady(args.Pressed);
    ...
    private void LobbyLateJoinStatusUpdated() => Lobby!.ReadyButton.Disabled = _gameTicker.DisallowedLateJoin;
