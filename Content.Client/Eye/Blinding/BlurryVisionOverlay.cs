...
public sealed class BlurryVisionOverlay : Overlay
{
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        var strength = (float) Math.Pow(Math.Min(_magnitude / BlurryVisionComponent.MaxMagnitude, 1.0f),
            _correctionPower);
        ...
        _cataractsShader.SetParameter("LIGHT_TEXTURE",
            args.Viewport.LightRenderTarget
                .Texture); // this is a little hacky but we spent way longer than we'd like to admit trying to do this a cleaner way to no avail
