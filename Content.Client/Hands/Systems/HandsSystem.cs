...
public sealed class HandsSystem : SharedHandsSystem
{
    ...
    private void HandleComponentState(Entity<HandsComponent> ent, ref ComponentHandleState args)
    {
        ...
        ent.Comp.SortedHands = new List<string>(state.SortedHands);
    ...
    public EntityUid? GetActiveHandEntity() =>
        TryGetPlayerHands(out var hands) ? GetActiveItem(hands.Value.AsNullable()) : null;
    ...
    /// </summary>
    public void UIHandActivate(string handName) => RaisePredictiveEvent(new RequestActivateInHandEvent(handName));
    ...
    private void HideLayers(EntityUid uid,
    ...
    protected override void HandleEntityInserted(EntityUid uid,
    ...
    protected override void HandleEntityRemoved(EntityUid uid,
        HandsComponent hands,
    ...
    private void UpdateHandVisuals(Entity<HandsComponent?, SpriteComponent?> ent, EntityUid held, string handId)
    {
        ...
        foreach (var (key, layerData) in ev.Layers)
        {
            ...
            if (displacement is not null &&
                _displacement.TryAddDisplacement(displacement, (ent, sprite), index, key, out var displacementKey))
