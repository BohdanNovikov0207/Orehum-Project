...
public sealed partial class ChemMasterWindow : FancyWindow
{
    ...
    private ReagentButton MakeReagentButton(string text,
    ...
    /// This was moved outside of BuildReagentRow to facilitate conditional logic, stops indentation depth getting out of hand
    /// as well.
    /// </summary>
    ...
    private void UpdatePanelInfo(ChemMasterBoundUserInterfaceState state)
    {
        ...
        foreach (var (reagent, quantity) in state.BufferReagents)
        {
            ...
            reagentList.Add(
                new ValueTuple<ReagentId, string, Color, FixedPoint2>(reagentId, name, reagentColor, quantity));
        }
        ...
        {
            BufferInfo.Children.Add(BuildReagentRow(reagent.color,
                rowCount++,
                reagent.name,
                reagent.reagentId,
                reagent.quantity,
    ...
    private void BuildContainerUI(Control control, ContainerInfo? info, bool addReagentButtons)
    {
        ...
        if (info.Entities != null)
        {
            ...
            {
                control.Children.Add(BuildReagentRow(default,
                    rowCount++,
                    id,
                    default,
                    quantity,
        ...
        if (info.Reagents != null)
        {
            foreach (var reagent in info.Reagents)
            {
                ...
                control.Children.Add(BuildReagentRow(reagentColor,
                    rowCount++,
                    name,
                    reagent.Reagent,
                    reagent.Quantity,
    ...
    /// </summary>
    private Control BuildReagentRow(Color reagentColor,
        int rowCount,
        string name,
        ReagentId reagent,
