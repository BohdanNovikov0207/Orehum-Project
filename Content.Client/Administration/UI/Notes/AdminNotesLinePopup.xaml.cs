...
public sealed partial class AdminNotesLinePopup : Popup
{
    ...
    public AdminNotesLinePopup(SharedAdminNote note, string playerName, bool showDelete, bool showEdit)
    {
        ...
        SeverityLabel.Text =
            Loc.GetString("admin-notes-severity", ("severity", note.NoteSeverity ?? NoteSeverity.None));
        ...
        CreatedAtLabel.Text = Loc.GetString("admin-notes-created-at",
        ...
        EditedAtLabel.Text = Loc.GetString("admin-notes-last-edited-at",
            ("date",
        ...
        ExpiryTimeLabel.Text = note.ExpiryTime == null
            ...
            : Loc.GetString("admin-notes-expires",
