...
/// <summary>
/// A simple window that displays solutions and their contained reagents. Allows you to edit the reagent quantities and add
/// new reagents.
/// </summary>
...
public sealed partial class EditSolutionsWindow : DefaultWindow
{
    ...
    private void UpdateThermalBox(Solution solution)
    {
        ...
        specificHeatLabel.Text = Loc.GetString("admin-solutions-window-specific-heat-label",
        ...
        heatCapacityLabel.Text = Loc.GetString("admin-solutions-window-heat-capacity-label",
    ...
    public void UpdateSolutions(List<(string, NetEntity)>? solutions)
    {
        ...
        var i = 0;
        var selectedIndex = 0; // Default to the first solution if none are found.
    ...
    public void SetState(EditSolutionsEuiState state) => _nextState = state;
}
