...
/// <summary>
/// A debug window that allows you to add a reagent to a solution. Intended to be used with
/// <see
...
public sealed partial class AddReagentWindow : DefaultWindow
{
    ...
    private readonly FloatSpinBox _quantitySpin = new(1, 2) { Value = 10, HorizontalExpand = true };
