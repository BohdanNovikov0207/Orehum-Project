...
public sealed class ContextMenuUIController : UIController, IOnStateEntered<GameplayState>,
    IOnStateExited<GameplayState>, IOnSystemChanged<CombatModeSystem>, IOnStateEntered<MappingState>,
    IOnStateExited<MappingState>
{
    ...
    public void OnStateEntered(GameplayState state) => Setup();

    public void OnStateEntered(MappingState state) => Setup();

    public void OnStateExited(GameplayState state) => Shutdown();

    public void OnStateExited(MappingState state) => Shutdown();

    public void OnSystemLoaded(CombatModeSystem system) => system.LocalPlayerCombatModeUpdated += OnCombatModeUpdated;

    public void OnSystemUnloaded(CombatModeSystem system) => system.LocalPlayerCombatModeUpdated -= OnCombatModeUpdated;
    ...
    public void OpenSubMenu(ContextMenuElement element)
    {
        ...
        var pos = altPos + new Vector2(element.Width + 2 * ContextMenuElement.ElementMargin,
