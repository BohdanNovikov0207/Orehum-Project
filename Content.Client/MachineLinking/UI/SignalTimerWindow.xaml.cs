...
public sealed partial class SignalTimerWindow : DefaultWindow
{
    ...
    // Mono
    public void CurrentDelayChange(TimeSpan newValue) => OnCurrentDelayChanged?.Invoke(newValue);

    public void SetCurrentText(string text) => CurrentTextEdit.Text = text;

    // Mono
    public void SetCurrentDelay(TimeSpan delay) => CurrentDelayEdit.Value = (float) delay.TotalSeconds;

    public void SetShowText(bool showTime) => TextEdit.Visible = showTime;

    public void SetTriggerTime(TimeSpan timeSpan) => _triggerTime = timeSpan;
    ...
    /// </summary>
    public TimeSpan GetDelay() => TimeSpan.FromSeconds(CurrentDelayEdit.Value); // Mono
}
