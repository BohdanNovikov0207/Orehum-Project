...
namespace Content.Client._Orehum.Traits.UI;
...
public sealed partial class TraitsTab : BoxContainer
{
    ...
    public TraitsTab()
    {
        ...
        _cfg.OnValueChanged(TraitsCCVars.MaxTraitCount, OnMaxTraitCountChanged, true);
        _cfg.OnValueChanged(TraitsCCVars.MaxTraitPoints, OnMaxTraitPointsChanged, true);
