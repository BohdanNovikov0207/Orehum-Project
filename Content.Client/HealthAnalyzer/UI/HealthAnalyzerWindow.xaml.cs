...
public sealed partial class HealthAnalyzerWindow : FancyWindow
{
    ...
    public void Populate(HealthAnalyzerBodyMessage msg)
    {
        ...
        if (msg.Unrevivable == true)
        {
            ...
            {
                Text = Loc.GetString("condition-body-unrevivable",
                    ("entity", Identity.Name(_target.Value, _entityManager))),
        ...
        foreach (var (bodyPart, isBleeding) in msg.Bleeding)
        {
            ...
            var locString = Loc.GetString($"condition-body-bleeding-{bodyPart.ToString()}",
                ("entity", Identity.Name(_target.Value, _entityManager)));
            ...
            foreach (var trauma in traumas)
            {
                ...
                else
                {
                    locString = trauma.SeverityString != null
                        ? Loc.GetString($"condition-body-trauma-{trauma.TraumaType}-{trauma.SeverityString}",
...
*/
    ...
    private void DrawDiseases(IReadOnlyList<EntityUid> diseases)
    {
        ...
        foreach (var diseaseUid in diseases)
        {
            ...
            diseaseInfoContainer.AddChild(CreateDiagnosticItemLabel(
                Loc.GetString("health-analyzer-window-disease-type-text", ("type", disease.Genotype))));
