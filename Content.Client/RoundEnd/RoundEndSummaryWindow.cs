...
public sealed class RoundEndSummaryWindow : DefaultWindow
{
    ...
    public RoundEndSummaryWindow(string gm,
        string roundEnd,
    ...
    private BoxContainer MakeRoundEndSummaryTab(string gamemode, string roundEnd, TimeSpan roundDuration, int roundId)
    {
        ...
        gamemodeMessage.AddMarkupOrThrow(Loc.GetString("round-end-summary-window-round-id-label",
            ("roundId", roundId)));
    ...
    private BoxContainer MakeStationReportTab()
    {
        ...
        var stationReportText = stationReportSystem.StationReportText ?? Loc.GetString("no-station-report-summited");
