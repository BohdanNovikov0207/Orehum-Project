...
public abstract class SlotControl : Control, IEntityControl
{
    ...
    private void OnButtonPressed(GUIBoundKeyEventArgs args) => Pressed?.Invoke(args, this);

    private void OnButtonUnpressed(GUIBoundKeyEventArgs args) => Unpressed?.Invoke(args, this);
    ...
    private void OnButtonHover(GUIMouseHoverEventArgs args) => Hover?.Invoke(args, this);
