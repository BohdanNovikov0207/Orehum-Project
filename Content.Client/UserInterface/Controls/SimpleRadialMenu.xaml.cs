...
public sealed partial class SimpleRadialMenu : RadialMenu
{
    ...
    public void Track(EntityUid owner) => _attachMenuToEntity = owner;
    ...
    private static RadialMenuTextureButtonWithSector ConvertToButtonWithSector(RadialMenuOption model,
        SimpleRadialMenuSettings settings)
    {
    ...
    private void UpdatePosition()
    {
        ...
        var coords = _entManager.System<SpriteSystem>()
...
public sealed class RadialMenuActionOption<T>(Action<T> onPressed, T data)
    : RadialMenuActionOption(() => onPressed(data));
