...
public sealed partial class DialogWindow : FancyWindow
{
    ...
    /// <remarks>
    /// Won't do anything on its own, you need to handle or network with <see cref="OnConfirmed" /> and
    /// <see cref="OnCancelled" />.
    /// </remarks>
    ...
    private bool VerifyInt(string input) => int.TryParse(input, out _);

    private bool VerifyFloat(string input) => float.TryParse(input, out _);
