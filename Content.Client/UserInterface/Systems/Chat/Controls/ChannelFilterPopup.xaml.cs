...
public sealed partial class ChannelFilterPopup : Popup
{
    ...
    public ChannelFilterPopup()
    {
        ...
        var highlights = cfg.GetCVar(CCVars.ChatHighlights);
    ...
    public bool IsActive(ChatChannel channel) =>
        _filterStates.TryGetValue(channel, out var checkbox) && checkbox.Pressed;
    ...
    public void UpdateHighlights(string highlights) => HighlightEdit.TextRope = new Rope.Leaf(highlights);
