...
{
    private readonly Dictionary<(string name, string description), Collapsible> _collapsibleBoxes = new();
    private readonly HashSet<(string name, string description)> _uncollapsedStates = new();
        ...
        SpriteSystem spriteSystem)
    {
        ...
        {
            var buttonHeading =
                new CollapsibleHeading(Loc.GetString("ghost-roles-window-available-button",
