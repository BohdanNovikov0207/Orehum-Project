...
public sealed class DamageVisualsSystem : VisualizerSystem<DamageVisualsComponent>
{
    ...
    private void InitializeVisualizer(EntityUid entity, DamageVisualsComponent damageVisComp)
    {
        ...
        if (damageComponent.DamageContainerID != null
            && _prototypeManager.TryIndex(damageComponent.DamageContainerID, out var damageContainer))
        {
    ...
    /// </summary>
    private void AddDamageLayerToSprite(Entity<SpriteComponent?> spriteEnt,
    ...
    private void HandleDamage(EntityUid uid, AppearanceComponent component, DamageVisualsComponent damageVisComp)
    {
        ...
        if (!AppearanceSystem.TryGetData<DamageVisualizerGroupData>(uid,
    ...
    /// any damage updates.
    /// </summary>
    private void UpdateDisabledLayers(EntityUid uid,
    ...
    private void ReorderOverlaySprite(Entity<SpriteComponent> spriteEnt,
        DamageVisualsComponent damageVisComp,
        DamageVisualizerSprite sprite,
        string key,
        string statePrefix,
    ...
    private void UpdateDamageVisuals(Entity<DamageableComponent, SpriteComponent, DamageVisualsComponent> entity)
    {
        ...
        if (!CheckThresholdBoundary(damageComponent.TotalDamage,
                damageVisComp.LastDamageThreshold,
                damageVisComp,
                out var threshold))
            return;
    ...
    /// passed into it.
    /// </summary>
    private void UpdateDamageVisuals(List<string> delta,
    ...
    /// </summary>
    private bool CheckThresholdBoundary(FixedPoint2 damageTotal,
    ...
    /// damage.
    /// </summary>
    private void UpdateTargetLayer(Entity<SpriteComponent> spriteEnt,
        DamageVisualsComponent damageVisComp,
        object layerMapKey,
        FixedPoint2 threshold)
    {
    ...
    /// </summary>
    private void UpdateTargetLayer(Entity<SpriteComponent, DamageVisualsComponent> entity,
        object layerMapKey,
        string damageGroup,
        FixedPoint2 threshold)
    {
        ...
        if (damageVisComp.Overlay && damageVisComp.DamageOverlayGroups != null)
        {
            if (damageVisComp.DamageOverlayGroups.ContainsKey(damageGroup) &&
                !damageVisComp.DisabledLayers[layerMapKey])
            {
                var layerState = damageVisComp.LayerMapKeyStates[layerMapKey];
                _sprite.LayerMapTryGet((entity, spriteComponent),
    ...
    /// </summary>
    private void UpdateOverlay(Entity<SpriteComponent, DamageVisualsComponent> entity,
        string damageGroup,
        FixedPoint2 threshold)
    {
        var spriteComponent = entity.Comp1;
    ...
    /// was passed into it.
    /// </summary>
    private void UpdateDamageLayerState(Entity<SpriteComponent> spriteEnt,
        int spriteLayer,
        string statePrefix,
        FixedPoint2 threshold)
    {
