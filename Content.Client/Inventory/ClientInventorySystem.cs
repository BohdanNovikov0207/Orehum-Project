...
public sealed class ClientInventorySystem : InventorySystem
{
    ...
    private void OnDidEquip(InventorySlotsComponent component, DidEquipEvent args)
    {
        ...
        if (args.Equipee != _playerManager.LocalEntity)
            return;
        var update = new SlotSpriteUpdate(args.Equipment,
            args.SlotGroup,
            args.Slot,
    ...
    public void UpdateSlot(EntityUid owner,
    ...
    public void UIInventoryActivate(string slot) => RaisePredictiveEvent(new UseSlotNetworkMessage(slot));
    ...
    public void UIInventoryActivateItem(string slot, EntityUid uid)
    {
        ...
        RaisePredictiveEvent(
            new InteractInventorySlotEvent(GetNetEntity(item.Value), false));
    }
    ...
    public void UIInventoryAltActivateItem(string slot, EntityUid uid)
    {
        ...
        RaisePredictiveEvent(new InteractInventorySlotEvent(GetNetEntity(item.Value), true));
    }
    ...
    public sealed class SlotData
    {
        ...
        public SlotData(SlotDefinition slotDef,
        ...
        public static implicit operator SlotData(SlotDefinition s) => new(s);

        public static implicit operator SlotDefinition(SlotData s) => s.SlotDef;
    }
