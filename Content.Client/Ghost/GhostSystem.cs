...
public sealed class GhostSystem : SharedGhostSystem
{
    ...
    private void OnGhostPlayerAttach(EntityUid uid,
    ...
    public void RequestWarps() => RaiseNetworkEvent(new GhostWarpsRequestEvent());
    ...
    public void OpenGhostRoles() => _console.RemoteExecuteCommand(null, "ghostroles");

    public void ToggleGhostVisibility(bool? visibility = null) => GhostVisibility = visibility ?? !GhostVisibility;
}
