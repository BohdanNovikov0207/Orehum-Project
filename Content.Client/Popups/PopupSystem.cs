...
public sealed class PopupSystem : SharedPopupSystem
{
        ...
        bool recordReplay)
    {
        ...
        if (recordReplay && _replayRecording.IsRecording)
        {
            if (entity != null)
                ...
                _replayRecording.RecordClientMessage(new PopupCoordinatesEvent(message,
                    type,
    ...
    public static float GetPopupLifetime(PopupLabel label) =>
        Math.Clamp(PopupLifetimePerCharacter * label.Text.Length,
    ...
    public override void PopupCoordinates(string? message,
        EntityCoordinates coordinates,
        PopupType type = PopupType.Small) => PopupMessage(message, type, coordinates, null, true);
    ...
    public override void PopupPredictedCoordinates(string? message,
        EntityCoordinates coordinates,
        EntityUid? recipient,
        PopupType type = PopupType.Small)
    {
    ...
    public override void PopupPredictedCursor(string? message,
        ICommonSession recipient,
        PopupType type = PopupType.Small) => PopupCursor(message, recipient, type);
    ...
    public override void PopupCoordinates(string? message,
        ...
        Filter filter,
        bool replayRecord,
        PopupType type = PopupType.Small) => PopupCoordinates(message, coordinates, type);
    ...
    public override void PopupClient(string? message,
        EntityUid uid,
        EntityUid? recipient,
        PopupType type = PopupType.Small)
    {
    ...
    public override void PopupPredicted(string? message,
        EntityUid uid,
        EntityUid? recipient,
        PopupType type = PopupType.Small)
    {
    ...
    public override void PopupPredicted(string? recipientMessage,
    ...
    private void OnPopupCursorEvent(PopupCursorEvent ev) => PopupCursorInternal(ev.Message, ev.Type, false);
