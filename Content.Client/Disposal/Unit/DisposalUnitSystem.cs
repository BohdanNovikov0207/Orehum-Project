...
public sealed class DisposalUnitSystem : SharedDisposalUnitSystem
{
    ...
    {
        if (_uiSystem.TryGetOpenUi<DisposalUnitBoundUserInterface>(entity.Owner,
    ...
    {
        if (!_appearanceSystem.TryGetData<DisposalUnitComponent.VisualState>(ent,
                DisposalUnitComponent.Visuals.VisualState,
                out var state,
                appearance))
            return;

        _sprite.LayerSetVisible((ent, sprite),
        ...
        var chargingState = _sprite.LayerMapTryGet((ent, sprite),
            DisposalUnitVisualLayers.BaseCharging,
        ...
        if (state == DisposalUnitComponent.VisualState.OverlayFlushing)
        {
            ...
            {
                var flushState = _sprite.LayerMapTryGet((ent, sprite),
                    DisposalUnitVisualLayers.OverlayFlush,
                    out var flushLayer,
                    false)
        ...
        if (!_appearanceSystem.TryGetData<DisposalUnitComponent.HandleState>(ent,
        ...
        if (!_appearanceSystem.TryGetData<DisposalUnitComponent.LightStates>(ent,
