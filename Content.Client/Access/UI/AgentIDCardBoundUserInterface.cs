...
public sealed class AgentIDCardBoundUserInterface : BoundUserInterface
{
    ...
    private void OnNumberChanged(uint newNumber) => SendMessage(new AgentIDCardNumberChangedMessage(newNumber));

    private void OnNameChanged(string newName) => SendMessage(new AgentIDCardNameChangedMessage(newName));

    private void OnJobChanged(string newJob) => SendMessage(new AgentIDCardJobChangedMessage(newJob));
