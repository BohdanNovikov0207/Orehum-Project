...
public sealed partial class ParticleAcceleratorControlMenu : FancyWindow
{
    ...
    public void SetEntity(EntityUid uid) => _entity = uid;
    ...
    private bool StrengthSpinBoxValid(int n) => n >= 0 && n <= _maxStrength;
    ...
    private void UpdatePowerState(ParticleAcceleratorPowerState state,
        bool enabled,
        bool assembled,
...
public sealed class PASegmentControl : Control
{
    ...
    {
        base.EnteredTree();
        _rsi = IoCManager.Resolve<IResourceCache>()
