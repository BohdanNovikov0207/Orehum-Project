...
namespace Content.Client.Backmen.Sponsors.SponsorManager.UI;
...
public sealed partial class SponsorWindow : DefaultWindow
{
    ...
    protected override void Opened()
    {
        ...
        {
            _ghostThemePrototypes = new List<GhostThemePrototype>();
        ...
        var selectedGhost = _cfg.GetCVar(CCVars.SponsorsSelectedGhost);
        var selectedInt = -1;

        GhostTheme.AddItem(Loc.GetString("sponsor-win-manager-ghost-default"), -1);
    ...
    private void GhostThemeChange(OptionButton.ItemSelectedEventArgs e)
    {
        ...
        _cfg.SetCVar(CCVars.SponsorsSelectedGhost, selectedGhost);
        _cfg.SaveToFile();
    }
}
