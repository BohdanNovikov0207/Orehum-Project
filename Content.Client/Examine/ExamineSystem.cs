...
public sealed class ExamineSystem : ExamineSystemShared
{
    ...
    private readonly List<Verb> _verbList = new();
    ...
    public override bool CanExamine(EntityUid examiner,
    ...
    private void AddExamineVerb(GetVerbsEvent<ExamineVerb> args)
    {
        ...
        verb.Icon = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/VerbIcons/examine.svg.192dpi.png"));
    ...
    private void OnExamineInfoResponse(ExamineSystemMessages.ExamineInfoResponseMessage ev)
    {
        ...
        UpdateTooltipInfo(player.Value, entity, ev.Message, ev.Verbs, false);
    }

    public override void SendExamineTooltip(EntityUid player,
        EntityUid target,
    ...
    /// </summary>
    public void OpenTooltip(EntityUid player,
        EntityUid target,
    ...
    /// </summary>
    public void UpdateTooltipInfo(EntityUid player,
        EntityUid target,
        FormattedMessage message,
