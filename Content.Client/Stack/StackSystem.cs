...
public sealed class StackSystem : SharedStackSystem
{
    ...
    private void OnAppearanceChange(EntityUid uid, StackComponent comp, ref AppearanceChangeEvent args)
    {
        ...
        if (comp.IsComposite)
            _counterSystem.ProcessCompositeSprite(uid, actual, maxCount, comp.LayerStates, hidden, args.Sprite);
        else
    ...
    /// <param name="maxCount">
    /// The maximum possible number of items in the stack. Will be set to the number of selectable
    /// layers.
    /// </param>
