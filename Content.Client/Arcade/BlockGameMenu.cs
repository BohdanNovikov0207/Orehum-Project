...
public sealed class BlockGameMenu : DefaultWindow
{
    ...
    public BlockGameMenu()
    {
        ...
        gameOverMenuContainer.AddChild(new Label
            { Text = Loc.GetString("blockgame-menu-msg-game-over"), Align = Label.AlignMode.Center });
    ...
    private void TryPause() => OnAction?.Invoke(BlockGamePlayerAction.Pause);
