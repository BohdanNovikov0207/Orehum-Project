...
public sealed partial class ChangelogManager : IPostInjectInit
{
    ...
    public const string MainChangelogName = "Orehum";
    ...
    public void PostInject() => _sawmill = _logManager.GetSawmill(SawmillName);
    ...
    public void SaveNewReadId()
    {
        ...
        using var sw =
            _resource.UserData.OpenWriteText(
                new ResPath($"/changelog_last_seen_{_configManager.GetCVar(CCVars.ServerId)}"));
