...
public sealed class CommunicationsConsoleBoundUserInterface : BoundUserInterface
{
    ...
    public void CallShuttle() => SendMessage(new CommunicationsConsoleCallEmergencyShuttleMessage());

    public void RecallShuttle() => SendMessage(new CommunicationsConsoleRecallEmergencyShuttleMessage());
