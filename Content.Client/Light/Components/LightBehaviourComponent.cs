...
public abstract partial class LightBehaviourAnimationTrack : AnimationTrackProperty
{
    ...
    [DataField("interpolate")] public AnimationInterpolationMode InterpolateMode { get; set; } =
    ...
    protected override void ApplyProperty(object context, object value) => ApplyProperty(value);
        ...
        else
        {
            switch (InterpolateMode)
            {
                case AnimationInterpolationMode.Linear:
                    ...
                    break;
                case AnimationInterpolationMode.Cubic:
                    ApplyProperty(InterpolateCubic(StartValue,
                        EndValue,
                        StartValue,
                        EndValue,
                        (interpolateValue - 0.5f) * 2f));
                    break;
                default:
                case AnimationInterpolationMode.Nearest:
        ...
        float frameTime)
    {
        ...
        switch (InterpolateMode)
        {
            case AnimationInterpolationMode.Linear:
                ...
                break;
            case AnimationInterpolationMode.Cubic:
                ApplyProperty(InterpolateCubic(_randomValue1,
                    _randomValue2,
                    _randomValue3,
                    _randomValue4,
                    interpolateValue));
