...
public sealed class RgbLightControllerSystem : SharedRgbLightControllerSystem
{
    ...
    private void OnHeldVisualsUpdated(EntityUid uid, RgbLightControllerComponent rgb, HeldVisualsUpdatedEvent args)
    {
        ...
        {
            if (!_sprite.LayerMapTryGet((args.User, sprite), key, out var index, false) ||
    ...
    private void OnEquipmentVisualsUpdated(EntityUid uid,
    ...
    private void GetOriginalColors(EntityUid uid,
    ...
    private void ResetOriginalColors(EntityUid uid,
        RgbLightControllerComponent? rgb = null,
        PointLightComponent? light = null,
        SpriteComponent? sprite = null)
    {
    ...
    public override void FrameUpdate(float frameTime)
    {
        ...
        {
            var color = GetCurrentRgbColor(_gameTiming.RealTime,
