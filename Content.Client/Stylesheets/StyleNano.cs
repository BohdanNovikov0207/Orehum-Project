...
public static class ResCacheExtension
{
    ...
    public static Font NotoStack(this IResourceCache resCache,
    ...
    public static Font NotoStack2ElectricBoogaloo(this IResourceCache resCache,
...
public sealed class StyleNano : StyleBase
{
    ...
    public StyleNano(IResourceCache resCache) : base(resCache)
    {
        ...
        var notoSansItalic10 = resCache.NotoStack("Italic");
        var notoSans12 = resCache.NotoStack(size: 12);
        var notoSansItalic12 = resCache.NotoStack("Italic", 12);
        var notoSansBold12 = resCache.NotoStack("Bold", 12);
        var notoSansBoldItalic12 = resCache.NotoStack("BoldItalic", 12);
        var notoSansBoldItalic14 = resCache.NotoStack("BoldItalic", 14);
        var notoSansBoldItalic16 = resCache.NotoStack("BoldItalic", 16);
        var notoSansDisplayBold14 = resCache.NotoStack("Bold", display: true, size: 14);
        var notoSansDisplayBold16 = resCache.NotoStack("Bold", display: true, size: 16);
        var notoSans15 = resCache.NotoStack("Regular", 15);
        var notoSans16 = resCache.NotoStack("Regular", 16);
        var notoSansBold16 = resCache.NotoStack("Bold", 16);
        var notoSansBold18 = resCache.NotoStack("Bold", 18);
        var notoSansBold20 = resCache.NotoStack("Bold", 20);
        var notoSansMono =
            resCache.NotoStack2ElectricBoogaloo("/EngineFonts/NotoSans/NotoSansMono-Regular.ttf",
                12); // Goobstation - ZH text support
        var robotoMonoBold11 = resCache.GetFont("/Fonts/RobotoMono/RobotoMono-Bold.ttf", 11);
        var robotoMonoBold12 = resCache.GetFont("/Fonts/RobotoMono/RobotoMono-Bold.ttf", 12);
        var robotoMonoBold14 = resCache.GetFont("/Fonts/RobotoMono/RobotoMono-Bold.ttf", 14);
        ...
        var outputPanelScrollDownButtonTex =
            resCache.GetTexture("/Textures/Interface/Nano/rounded_button_half_bordered.svg.96dpi.png");
        ...
        var monotoneCheckBoxTextureUnchecked =
            resCache.GetTexture("/Textures/Interface/Nano/Monotone/monotone_checkbox_unchecked.svg.96dpi.png");
        ...
        var boxFont13 =
            resCache.NotoStack2ElectricBoogaloo("/Fonts/Boxfont-round/Boxfont Round.ttf",
                13); // Goobstation - ZH text support
...
// ListContainer
                ...
                // CheckBox
                new StyleRule(new SelectorElement(typeof(TextureRect),
                ...
                new StyleRule(new SelectorElement(typeof(TextureRect),
                        new[] { MonotoneCheckBox.StyleClassMonotoneCheckBox, CheckBox.StyleClassCheckBoxChecked },
                        null,
                        null),
                    new[]
                    {
                ...
                new StyleRule(new SelectorElement(typeof(PanelContainer),
                ...
                // alert tooltip
                new StyleRule(new SelectorElement(typeof(RichTextLabel),
                ...
                new StyleRule(new SelectorElement(typeof(Label),
                ...
                new StyleRule(new SelectorElement(typeof(ItemList), new[] { "transparentItemList" }, null, null),
                    new[]
                    {
                        new StyleProperty(ItemList.StylePropertyBackground,
                ...
                new StyleRule(new SelectorElement(typeof(ItemList),
                ...
                // Tree
                new StyleRule(new SelectorElement(typeof(Tree), null, null, null),
                    new[]
                    {
                        new StyleProperty(Tree.StylePropertyBackground,
                            new StyleBoxFlat { BackgroundColor = new Color(32, 32, 40) }),
                        new StyleProperty(Tree.StylePropertyItemBoxSelected,
                            new StyleBoxFlat
                            {
                ...
                // Big Label
                new StyleRule(new SelectorElement(typeof(Label), new[] { StyleClassLabelHeading }, null, null),
                    new[]
                    {
                ...
                // Small Label
                new StyleRule(new SelectorElement(typeof(Label), new[] { StyleClassLabelSubText }, null, null),
                    new[]
                    {
                ...
                // Label Key
                new StyleRule(new SelectorElement(typeof(Label), new[] { StyleClassLabelKeyText }, null, null),
                    new[]
                    {
                        new StyleProperty(Label.StylePropertyFont, notoSansBold12),
                        new StyleProperty(Label.StylePropertyFontColor, NanoGold),
                ...
                // Console text
                new StyleRule(new SelectorElement(typeof(Label), new[] { StyleClassConsoleText }, null, null),
                    new[]
                    {
                        new StyleProperty(Label.StylePropertyFont, robotoMonoBold11),
                    }),

                new StyleRule(new SelectorElement(typeof(Label), new[] { StyleClassConsoleSubHeading }, null, null),
                    new[]
                    {
                        new StyleProperty(Label.StylePropertyFont, robotoMonoBold12),
                    }),

                new StyleRule(new SelectorElement(typeof(Label), new[] { StyleClassConsoleHeading }, null, null),
                    new[]
                    {
                ...
                new StyleRule(new SelectorElement(typeof(Label), new[] { StyleClassPowerStateNone }, null, null),
                    new[]
                    {
                        new StyleProperty(Label.StylePropertyFontColor, new Color(0.8f, 0.0f, 0.0f)),
                    }),

                new StyleRule(new SelectorElement(typeof(Label), new[] { StyleClassPowerStateLow }, null, null),
                    new[]
                    {
                        new StyleProperty(Label.StylePropertyFontColor, new Color(0.9f, 0.36f, 0.0f)),
                    }),

                new StyleRule(new SelectorElement(typeof(Label), new[] { StyleClassPowerStateGood }, null, null),
                    new[]
                    {
                ...
                new StyleRule(
                    new SelectorElement(typeof(MenuButton),
                ...
                new StyleRule(SelectorElement.Class(StyleClassItemStatus),
                    new[]
                    {
                        new StyleProperty("font", notoSans10),
                    }),
                ...
                // Slider
                new StyleRule(SelectorElement.Type(typeof(Slider)),
                    new[]
                    {
                ...
                new StyleRule(SelectorElement.Type(typeof(ColorableSlider)),
                    new[]
                    {
                ...
                new StyleRule(new SelectorElement(typeof(Slider), new[] { StyleClassSliderRed }, null, null),
                    new[]
                    {
                        new StyleProperty(Slider.StylePropertyFill, sliderFillRed),
                    }),

                new StyleRule(new SelectorElement(typeof(Slider), new[] { StyleClassSliderGreen }, null, null),
                    new[]
                    {
                        new StyleProperty(Slider.StylePropertyFill, sliderFillGreen),
                    }),

                new StyleRule(new SelectorElement(typeof(Slider), new[] { StyleClassSliderBlue }, null, null),
                    new[]
                    {
                        new StyleProperty(Slider.StylePropertyFill, sliderFillBlue),
                    }),

                new StyleRule(new SelectorElement(typeof(Slider), new[] { StyleClassSliderWhite }, null, null),
                    new[]
                    {
                ...
                // chat filter button
                new StyleRule(new SelectorElement(typeof(ContainerButton),
                ...
                new StyleRule(new SelectorElement(typeof(OptionButton),
                        null,
                        null,
                        new[] { ContainerButton.StylePseudoClassNormal }),
                    new[]
                ...
                Element<PanelContainer>()
                    .Class("PanelBackgroundBaseLight") // Goob Station
                    .Prop("panel", new StyleBoxTexture(BaseButtonOpenBoth) { Padding = default })
                ...
                Element<TextureRect>()
                    .Class("SyndicateLogo")
                    .Prop(TextureRect.StylePropertyTexture,
                        resCache.GetTexture("/Textures/_Goobstation/Interface/syndicate_logo_white.svg.96dpi.png"))
                    .Prop(Control.StylePropertyModulateSelf, Color.FromHex("#757575")),
                ...
                new StyleRule(
                    ...
                    new[]
                    {
                        new StyleProperty(TextureButton.StylePropertyTexture,
