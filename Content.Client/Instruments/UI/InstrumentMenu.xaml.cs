...
public sealed partial class InstrumentMenu : DefaultWindow
{
    ...
    public void SetMIDI(bool available) => UnavailableOverlay.Visible = !available;
    ...
    private void ChannelsButtonOnPressed(ButtonEventArgs obj) => OnOpenChannels?.Invoke();

    private void InstrumentOnMidiPlaybackEnded() => MidiPlaybackSetButtonsDisabled(true);
