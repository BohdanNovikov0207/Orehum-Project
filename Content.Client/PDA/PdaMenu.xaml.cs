...
public sealed partial class PdaMenu : PdaWindow
{
    ...
    [Dependency]
    private readonly ILocalizationManager
        _locMan = default!; // CorvaxGoob-custom-alert-instructions-in-pda // I made this for no warning by me
    ...
    public PdaMenu()
    {
        ...
        HomeButton.IconTexture = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/home.png"));
        FlashLightToggleButton.IconTexture = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/light.png"));
        EjectPenButton.IconTexture = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/pencil.png"));
        EjectIdButton.IconTexture = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/eject.png"));
        EjectPaiButton.IconTexture = new SpriteSpecifier.Texture(new ResPath("/Textures/Interface/pai.png"));
        ProgramCloseButton.IconTexture =
