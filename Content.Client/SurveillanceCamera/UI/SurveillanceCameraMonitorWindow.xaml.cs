...
public sealed partial class SurveillanceCameraMonitorWindow : FancyWindow // Goobstation
{
    ...
    [Dependency] private readonly IEntityManager _entManager = default!; // Goobstation
    ...
    public void SetEntity(EntityUid uid)
    {
        ...
        if (_entManager.TryGetComponent<TransformComponent>(uid, out var xform))
        {
            ...
            msg.AddMarkupOrThrow(Loc.GetString("surveillance-camera-monitor-ui-station-name",
