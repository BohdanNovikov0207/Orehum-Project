...
internal sealed class ConstructionMenuPresenter : IDisposable
{
    ...
    private readonly List<ConstructionPrototype> _favoritedRecipes = [];
    ...
    private bool _autoFocusSearch; // Goobstation
    ...
    public ConstructionMenuPresenter()
    {
        ...
        _cfg.OnValueChanged(GoobCVars.AutoFocusSearchOnBuildMenu, UpdateAutoFocus);
    ...
    public void OnHudCraftingButtonToggled(BaseButton.ButtonToggledEventArgs args) => WindowOpen = args.Pressed;

    private void OnPlacementChanged(object? sender, EventArgs e) => _constructionView.ResetPlacement();
    ...
    private List<ConstructionMenu.ConstructionMenuListData> GetAndSortRecipes((string, string) args)
    {
        ...
        foreach (var recipe in _prototypeManager.EnumeratePrototypes<ConstructionPrototype>())
        {
            ...
            recipes.Add(new ConstructionMenu.ConstructionMenuListData(recipe, proto));
        }
    ...
    public void SetFavorites(IReadOnlyList<ProtoId<ConstructionPrototype>> favorites)
    {
        ...
        {
            if (_prototypeManager.TryIndex(id, out var recipe, false))
