...
public sealed partial class LauncherConnectingGui : Control
{
    ...
    private void CopyButtonPressed(BaseButton.ButtonEventArgs args) => CopyText(ConnectFailReason.Text);

    private void CopyButtonDisconnectedPressed(BaseButton.ButtonEventArgs args) => CopyText(DisconnectReason.Text);
    ...
    private void LastNetDisconnectedArgsChanged(NetDisconnectedArgs? args) => HandleDisconnectReason(args);
