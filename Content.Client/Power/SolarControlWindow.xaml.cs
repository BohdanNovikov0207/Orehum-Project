...
public sealed class SolarControlNotARadar : Control
{
    ...
    public Angle PredictedPanelRotation => _lastState.Rotation +
                                           _lastState.AngularVelocity *
                                           (_gameTiming.CurTime - _lastStateTime).TotalSeconds;
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        handle.DrawLine(new Vector2(point, point) + extent / panelExtentCutback,
