...
public sealed class XenomorphInfectionIconSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<XenomorphLarvaVictimComponent, GetStatusIconsEvent>(
            OnXenomorphLarvaVictimGetStatusIconsEvent);
    }

    private void OnXenomorphInfectedGetStatusIconsEvent(EntityUid uid,
        XenomorphInfectedComponent component,
    ...
    private void OnXenomorphLarvaVictimGetStatusIconsEvent(EntityUid uid,
        XenomorphLarvaVictimComponent component,
        ref GetStatusIconsEvent args)
    {
