...
public sealed partial class IconSmoothSystem : EntitySystem
{
    ...
    public override void FrameUpdate(float frameTime)
    {
        ...
        while (_anchorChangedEntities.TryDequeue(out var uid))
        {
            ...
            DirtyNeighbours(uid, null, xform, smoothQuery);
        }
    ...
    public void DirtyNeighbours(EntityUid uid,
    ...
    private void CalculateNewSpriteDiagonal(Entity<MapGridComponent>? gridEntity,
        ...
        EntityQuery<IconSmoothComponent> smoothQuery)
    {
        ...
        for (var i = 0; i < neighbors.Length; i++)
        {
            ...
            matching = matching && MatchingEntity(smooth,
    ...
    private void CalculateNewSpriteCardinal(Entity<MapGridComponent>? gridEntity,
        IconSmoothComponent smooth,
        Entity<SpriteComponent> sprite,
        TransformComponent xform,
        EntityQuery<IconSmoothComponent> smoothQuery)
    ...
    private bool MatchingEntity(IconSmoothComponent smooth,
    ...
    private void CalculateNewSpriteCorners(Entity<MapGridComponent>? gridEntity,
        IconSmoothComponent smooth,
