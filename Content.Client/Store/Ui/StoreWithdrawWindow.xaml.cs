...
{
    private readonly HashSet<CurrencyWithdrawButton> _buttons = new();
    [Dependency] private readonly IPrototypeManager _prototypeManager = default!;

    private readonly Dictionary<CurrencyPrototype, FixedPoint2> _validCurrencies = new();
    ...
    public void CreateCurrencyButtons(Dictionary<ProtoId<CurrencyPrototype>, FixedPoint2> balance)
    {
        ...
        foreach (var currency in _validCurrencies)
        {
            ...
            var button = new CurrencyWithdrawButton
            {
                ...
                MinHeight = 20,
                Text = Loc.GetString("store-withdraw-button-ui",
                    ("currency", Loc.GetString(currency.Key.DisplayName, ("amount", currency.Value)))),
                Disabled = false,
            };
