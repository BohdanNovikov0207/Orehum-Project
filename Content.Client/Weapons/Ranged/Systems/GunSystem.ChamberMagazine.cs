...
public sealed partial class GunSystem
{
    ...
    private void OnChamberMagazineAppearance(EntityUid uid,
    ...
    private void OnChamberMagazineCounter(EntityUid uid,
        ChamberMagazineAmmoProviderComponent component,
        AmmoCounterControlEvent args) => args.Control = new ChamberMagazineStatusControl();

    private void OnChamberMagazineAmmoUpdate(EntityUid uid,
        ChamberMagazineAmmoProviderComponent component,
