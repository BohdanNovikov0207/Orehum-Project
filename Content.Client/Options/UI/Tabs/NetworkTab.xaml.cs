...
public sealed partial class NetworkTab : Control
{
    ...
    private void OnPredictToggled(BaseButton.ButtonToggledEventArgs obj) => UpdateChanges();

    private void OnSliderChanged(Robust.Client.UserInterface.Controls.Range range) => UpdateChanges();
    ...
    private void OnResetButtonPressed(BaseButton.ButtonEventArgs args) => Reset();
