...
public sealed partial class KeyRebindTab : Control
{
    ...
    public KeyRebindTab()
    {
        ...
        AddCheckBox("ui-options-hotkey-keymap",
    ...
    private void OnKeyBindRemoved(IKeyBinding obj) => OnKeyBindModified(obj, true);

    private void OnKeyBindAdded(IKeyBinding obj) => OnKeyBindModified(obj, false);
    ...
    private sealed class BindButton : Control
    {
        ...
        public void UpdateText() => Button.Text = Binding?.GetKeyString() ?? Loc.GetString("ui-options-unbound");
    }
}
