...
public sealed partial class AdminOptionsTab : Control
{
    ...
    public AdminOptionsTab()
    {
        ...
        {
            antagFormats.Add(new OptionDropDownCVar<string>.ValueOption(format.ToString()!,
        ...
        {
            antagSymbolStyles.Add(new OptionDropDownCVar<string>.ValueOption(symbol.ToString()!,
        ...
        {
            playerTabColorSettings.Add(new OptionDropDownCVar<string>.ValueOption(setting.ToString()!,
        ...
        {
            playerTabRoleSettings.Add(new OptionDropDownCVar<string>.ValueOption(setting.ToString()!,
        ...
        {
            playerTabSymbolSettings.Add(new OptionDropDownCVar<string>.ValueOption(setting.ToString()!,
                Loc.GetString($"ui-options-admin-player-tab-symbol-setting-{setting.ToString()!.ToLower()}")));
        }

        Control.AddOptionDropDown(CCVars.AdminPlayerTabSymbolSetting,
            DropDownPlayerTabSymbolSetting,
            playerTabSymbolSettings);
        Control.AddOptionDropDown(CCVars.AdminPlayerTabRoleSetting,
            DropDownPlayerTabRoleSetting,
            playerTabRoleSettings);
        Control.AddOptionDropDown(CCVars.AdminPlayerTabColorSetting,
        ...
        // Goobstation Start - Admin Notifications
        Control.AddOptionPercentSlider(
