...
public sealed partial class MiscTab : Control
{
    ...
    public MiscTab()
    {
        ...
        {
            layoutEntries.Add(new OptionDropDownCVar<string>.ValueOption(layout.ToString()!,
        ...
        Control.AddOptionCheckBox(GoobCVars.AutoFocusSearchOnBuildMenu,
            AutoFocusSearchOnBuildMenuCheckBox); // Goobstation Change
        ...
        Control.AddOptionCheckBox(CCCVars.OfferModeIndicatorsPointShow,
            ShowOfferModeIndicatorsCheckBox); // CorvaxGoob-Offer
        Control.Initialize();
    }
}
