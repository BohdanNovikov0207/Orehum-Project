...
public class StaticSpriteView : Control
{
    ...
    public void SetEntity(EntityUid? uid)
    {
        ...
        Entity = new Entity<SpriteComponent, TransformComponent>(uid.Value, sprite, xform);
    ...
    private void UpdateSize()
    {
        ...
        if (_worldRotation != null
            &&
            _eyeRotation ==
            Angle.Zero) // TODO This shouldn't need to be here, but I just give up at this point I am going fucking insane looking at rotating blobs of pixels. I doubt anyone will ever even use rotated sprite views.?
        {
    ...
    protected override void Draw(IRenderHandle renderHandle)
    {
        ...
        var offset = SpriteOffset
            ? Vector2.Zero
            : -(-_eyeRotation).RotateVec(_cachedSprite.Offset * _scale) * new Vector2(1, -1) *
