...
public sealed partial class GameDirectorSystem : GameRuleSystem<GameDirectorComponent>
{
    ...
    protected override void Added(EntityUid uid,
        GameDirectorComponent scheduler,
        ...
        float frameTime)
    {
        ...
        {
            var minimumTimeUntilFirstEvent =
                _configManager.GetCVar(GoobCVars.MinimumTimeUntilFirstEvent) / _event.EventSpeedup;
        ...
        if (chosenEvent != null)
        {
            ...
            scheduler.TimeNextEvent = currTime +
                                      TimeSpan.FromSeconds(_random.NextFloat(beat.EventDelayMin, beat.EventDelayMax) /
                                                           _event.EventSpeedup);
        }
        else
        {
