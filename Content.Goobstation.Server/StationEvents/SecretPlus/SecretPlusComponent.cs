...
/// Events are weighted by their normal weight and by roughly how close they are to (the negative of) the current chaos
/// score.
...
public sealed partial class SecretPlusComponent : Component
{
    ...
    /// Higher values equalise event chances, especially so for lower-chaos events. Makes them happen more frequently even at
    /// high chaos scores.
    /// </summary>
    [DataField]
    ...
    /// Normally used for roundstart antags, but will still generate if they are disabled and will then be spent on midround
    /// events.
    /// </summary>
    [DataField]
    ...
    /// For example, if you set this to 1/60, after 60 seconds chaos generation and event frequency will be doubled, and
    /// reoccurence delays halved.
    /// </summary>
    [DataField]
