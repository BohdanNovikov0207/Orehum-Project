...
public sealed class DisposalBlockerSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<DisposalBlockerComponent, GetDisposalsConnectableDirectionsEvent>(
            OnGetBlockerConnectableDirections);
        SubscribeLocalEvent<DisposalBlockerComponent, GetDisposalsNextDirectionEvent>(OnGetBlockerNextDirection);
    }

    private void OnGetBlockerConnectableDirections(EntityUid uid,
        DisposalBlockerComponent component,
        ref GetDisposalsConnectableDirectionsEvent args) =>
        _disposalSystem.OnGetTransitConnectableDirections(uid, component, ref args);

    private void OnGetBlockerNextDirection(EntityUid uid,
        DisposalBlockerComponent component,
