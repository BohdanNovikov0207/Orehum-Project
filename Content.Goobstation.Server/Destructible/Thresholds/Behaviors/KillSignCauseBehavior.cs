...
public sealed partial class KillSignCauseBehavior : IThresholdBehavior
{
    public void Execute(EntityUid owner, DestructibleSystem system, EntityUid? cause = null)
    {
        ...
        if (!system.EntityManager.TryGetComponent<KillSignComponent>(causeVal, out var killsignComp))
        {
            ...
            system._adminLogger.Add(LogType.Trigger,
                LogImpact.High,
                $"{system.EntityManager.ToPrettyString(causeVal):entity} was Killsigned because they broke a Christmas tree: {system.EntityManager.ToPrettyString(owner):entity}.");
        }
    }
}
