...
public sealed partial class PhaseShiftedComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier PhaseInSound = new SoundPathSpecifier(new ResPath("/Audio/_EE/Shadowling/veilin.ogg"));

    [DataField]
    public SoundSpecifier PhaseOutSound =
        new SoundPathSpecifier(new ResPath("/Audio/_EE/Shadowling/veilout.ogg"));
