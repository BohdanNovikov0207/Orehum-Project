...
public sealed class ShadowlingAscensionEggInteractionSystem : EntitySystem
{
    ...
    private void OnEggOpenAttempt(EntityUid uid,
        ShadowlingAscensionEggComponent component,
        ref StorageOpenAttemptEvent args) => args.Cancelled = true;

    private void OnEggCloseAttempt(EntityUid uid,
        ShadowlingAscensionEggComponent component,
        ref StorageCloseAttemptEvent args) => args.Cancelled = true;
}
