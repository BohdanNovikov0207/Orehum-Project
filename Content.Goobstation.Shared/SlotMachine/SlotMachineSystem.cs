...
public sealed class SlotMachineSystem : EntitySystem
{
    ...
    private void OnSlotMachineDoAfter(EntityUid uid, SlotMachineComponent comp, SlotMachineDoAfterEvent args)
    {
        ...
        if (_random.Prob(comp.SmallWinChance))
        {
            ...
            HandlePrize(uid,
                Loc.GetString("slotmachine-win-normal", ("amount", comp.SmallPrizeAmount)),
                stack,
                comp.SmallPrizeAmount);
            return;
        }
        ...
        if (_random.Prob(comp.MediumWinChance))
        {
            ...
            HandlePrize(uid,
                Loc.GetString("slotmachine-win-normal", ("amount", comp.MediumPrizeAmount)),
                stack,
                comp.MediumPrizeAmount);
            return;
        }
        ...
        if (_random.Prob(comp.BigWinChance))
        {
            ...
            HandlePrize(uid,
                Loc.GetString("slotmachine-win-normal", ("amount", comp.BigPrizeAmount)),
                stack,
                comp.BigPrizeAmount);
            return;
        }
        ...
        if (_random.Prob(comp.GodPotWinChance)) // THE GODPOT!!!
        {
            ...
            _chatSystem.TrySendInGameICMessage(uid,
                Loc.GetString("slotmachine-win-godpot"),
    ...
    private void HandlePrize(EntityUid uid, string msg, StackComponent? stack, int prize)
    {
        if (stack == null)
        {
            ...
            _chatSystem.TrySendInGameICMessage(uid, msg, InGameICChatType.Speak, false, true, checkRadioPrefix: false);
            return;
        }
