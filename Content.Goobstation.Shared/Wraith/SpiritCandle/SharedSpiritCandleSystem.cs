...
/// </summary>
public sealed class SharedSpiritCandleSystem : EntitySystem
{
    [Dependency] private readonly SharedAppearanceSystem _appearance = default!;
    [Dependency] private readonly SharedAudioSystem _audio = default!;
    [Dependency] private readonly SharedChargesSystem _charges = default!;
    [Dependency] private readonly INetManager _netManager = default!;
    [Dependency] private readonly StatusEffectsSystem _oldStatusEffects = default!;
    ...
    private void OnUseInHand(Entity<SpiritCandleComponent> ent, ref UseInHandEvent args)
    {
        ...
        foreach (var ghost in area.EntitiesInside)
        {
            ...
            _oldStatusEffects.TryAddStatusEffect<CorporealComponent>(ghostUid,
                ent.Comp.Corporeal,
                ent.Comp.CorporealDuration,
                true);
    ...
    private void OnAttemptCollideSpiritCandle(Entity<CorporealComponent> ent,
        ref AttemptCollideSpiritCandleEvent args) =>
