...
[Serializable] [NetSerializable]
public sealed class NameFilterSetNameMessage(string name) : BoundUserInterfaceMessage
{
    public readonly string Name = name;
}

[Serializable] [NetSerializable]
public sealed class NameFilterSetModeMessage(NameFilterMode mode) : BoundUserInterfaceMessage
{
