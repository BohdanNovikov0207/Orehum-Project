    ...
    : IEquatable<GpsEntry>
{
    ...
    public override bool Equals(object? obj) => ReferenceEquals(this, obj) || obj is GpsEntry other && Equals(other);

    public override int GetHashCode() => HashCode.Combine(NetEntity, Name, PrototypeId, IsDistress, Color);
}
