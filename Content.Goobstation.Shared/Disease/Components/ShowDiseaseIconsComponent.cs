...
{
    /// <summary>
    /// The minimum product of disease complexity with its progress for the high danger icon to show up. Doesn't show up if
    /// null.
    /// </summary>
    ...
    /// <summary>
    /// The minimum product of disease complexity with its progress for the medium danger icon to show up. Doesn't show up if
    /// null.
    /// </summary>
    [DataField] [AutoNetworkedField]
