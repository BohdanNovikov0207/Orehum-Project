...
public sealed class DummyParallaxManager : IParallaxManager
{
    ...
    public bool IsLoaded(string name) => true;

    public ParallaxLayerPrepared[] GetParallaxLayers(string name) => Array.Empty<ParallaxLayerPrepared>();

    public void LoadDefaultParallax()
    {
    }

    public Task LoadParallaxByName(string name) => Task.CompletedTask;
