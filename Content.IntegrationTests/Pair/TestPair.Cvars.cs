...
public sealed partial class TestPair
{
    ...
    private void OnServerCvarChanged(CVarChangeInfo args) => _modifiedServerCvars.TryAdd(args.Name, args.OldValue);

    private void OnClientCvarChanged(CVarChangeInfo args) => _modifiedClientCvars.TryAdd(args.Name, args.OldValue);
