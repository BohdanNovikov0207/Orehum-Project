...
public sealed class StorageTest
{
    ...
    private int GetEntrySize(EntitySpawnEntry entry,
        bool getCount,
    ...
    private int GetFillSize(StorageFillComponent fill,
        bool getCount,
        IPrototypeManager protoMan,
        SharedItemSystem itemSystem)
    {
