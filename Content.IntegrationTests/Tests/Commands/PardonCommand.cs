...
public sealed class PardonCommand
{
    ...
    public async Task PardonTest()
    {
        ...
        Assert.Multiple(async () =>
        {
            ...
            Assert.That(ban.ExpirationTime.Value.UtcDateTime - DateTime.UtcNow.AddHours(24),
        ...
        Assert.Multiple(async () =>
        {
            ...
            Assert.That(pardonedBan.ExpirationTime.Value.UtcDateTime - DateTime.UtcNow.AddHours(24),
                Is.LessThanOrEqualTo(MarginOfError));
