...
public sealed class SaveLoadSaveTest
{
    ...
    private const string
        TestMap =
            "Maps/_Goobstation/bagel.yml"; // Goob edit - what point is there in testing a map without any goob features??
    ...
    {
        public bool Enabled;
        public override void Initialize() => SubscribeLocalEvent<AfterSerializationEvent>(OnAfterSave);
