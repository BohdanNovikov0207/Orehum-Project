    ...
    public async Task SaveLoadMultiGridMap()
    {
        ...
        await server.WaitAssertion(() =>
        {
...

            {
                ...
                mapSystem.SetTile(mapGrid, new Vector2i(0, 0), new Tile(1, 1, 255));
            }
            {
                var mapGrid = mapManager.CreateGridEntity(mapId);
                xformSystem.SetWorldPosition(mapGrid, new Vector2(-8, -8));
                mapSystem.SetTile(mapGrid, new Vector2i(0, 0), new Tile(2, 1, 254));
            }
        ...
        {
            {
                ...
                Assert.Multiple(() =>
                {
                    ...
                    Assert.That(mapSystem.GetTileRef(gridUid, mapGrid, new Vector2i(0, 0)).Tile,
                        Is.EqualTo(new Tile(1, 1, 255)));
                });
            }
            {
