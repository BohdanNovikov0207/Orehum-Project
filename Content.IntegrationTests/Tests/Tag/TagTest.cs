    ...
    public async Task TagComponentTest()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(tagSystem.AddTags(sTagEntity, new List<ProtoId<TagPrototype>> { StartingTag, StartingTag }),
                    Is.False);
                Assert.That(tagSystem.AddTags(sTagEntity,
                ...
                Assert.That(tagSystem.HasAllTags(sTagComponent,
                ...
                Assert.That(tagSystem.HasAnyTag(sTagComponent,
                        new List<ProtoId<TagPrototype>> { StartingTag, StartingTag }),
                    Is.True);
                Assert.That(tagSystem.HasAnyTag(sTagComponent,
                        new HashSet<ProtoId<TagPrototype>> { StartingTag, StartingTag }),
                ...
                Assert.That(tagSystem.HasAllTags(sTagComponent, new List<ProtoId<TagPrototype>> { AddedTag, AddedTag }),
                    Is.False);
                Assert.That(tagSystem.HasAllTags(sTagComponent,
                        new HashSet<ProtoId<TagPrototype>> { AddedTag, AddedTag }),
                    Is.False);

                Assert.That(tagSystem.HasAnyTag(sTagComponent, AddedTag, AddedTag), Is.False);
                Assert.That(tagSystem.HasAnyTag(sTagComponent, new List<ProtoId<TagPrototype>> { AddedTag, AddedTag }),
                    Is.False);
                Assert.That(tagSystem.HasAnyTag(sTagComponent,
                        new HashSet<ProtoId<TagPrototype>> { AddedTag, AddedTag }),
                    Is.False);
                ...
                Assert.That(tagSystem.HasAnyTag(sTagComponent,
                        new List<ProtoId<TagPrototype>> { StartingTag, AddedTag }),
                    Is.True);
                Assert.That(tagSystem.HasAnyTag(sTagComponent,
                ...
                Assert.That(tagSystem.RemoveTags(sTagEntity, new List<ProtoId<TagPrototype>> { AddedTag, AddedTag }),
                    Is.False);
                Assert.That(tagSystem.RemoveTags(sTagEntity, new HashSet<ProtoId<TagPrototype>> { AddedTag, AddedTag }),
                    Is.False);
            });
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(tagSystem.AddTags(sTagEntity, new List<ProtoId<TagPrototype>> { StartingTag, AddedTag }),
                    Is.False);
                Assert.That(tagSystem.AddTags(sTagEntity, new HashSet<ProtoId<TagPrototype>> { StartingTag, AddedTag }),
                    Is.False);
                ...
                Assert.That(tagSystem.HasAllTags(sTagComponent,
                    ...
                    Is.True);
                Assert.That(tagSystem.HasAllTags(sTagComponent,
                        new List<ProtoId<TagPrototype>> { AddedTag, StartingTag }),
                    Is.True);
                Assert.That(tagSystem.HasAllTags(sTagComponent,
                        new HashSet<ProtoId<TagPrototype>> { StartingTag, AddedTag }),
                    Is.True);
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(tagSystem.RemoveTags(sTagEntity, new List<ProtoId<TagPrototype>> { StartingTag, AddedTag }),
                    Is.False);
