...
public class EntityFetchBenchmark
{
    ...
    {
        bool TryGetEntity(TEntityUid entityUid, out TEntity entity);
    }
    ...
    private readonly struct DictEntityUid : IEquatable<DictEntityUid>
    {
        ...
        public bool Equals(DictEntityUid other) => Value == other.Value;

        public override bool Equals(object obj) => obj is DictEntityUid other && Equals(other);

        public override int GetHashCode() => Value;

        public static bool operator ==(DictEntityUid left, DictEntityUid right) => left.Equals(right);
