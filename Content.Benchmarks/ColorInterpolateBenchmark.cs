...
public class ColorInterpolateBenchmark
{
    ...
    [MethodImpl(AggressiveOpt)]
    public static Color InterpolateSysVector4(Color a,
        Color b,
        float lambda)
    {
    ...
    [MethodImpl(AggressiveOpt)]
    public static Color InterpolateSysVector4In(in Color endPoint1,
        in Color endPoint2,
        float lambda)
    {
...
#if NETCOREAPP
    [MethodImpl(AggressiveOpt)]
    public static Color InterpolateSimd(Color a,
        Color b,
        float lambda)
    {
    ...
    [MethodImpl(AggressiveOpt)]
    public static Color InterpolateSimdIn(in Color a,
        in Color b,
        float lambda)
    {
