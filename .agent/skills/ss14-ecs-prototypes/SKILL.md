...
# Wrong
- type: entity
  id: underscores_woed     # underscores

- type: entity
  id: hyphens-word         # hyphens

- type: entity
  id: UPPERCASE            # all uppercase

- type: entity
  id: lowercase            # all lowercase
```
...
- type: entity
  id: Mor5hey97Beer
  parent: [DrinkBottleVisualsAll, DrinkBottleGlassSmallBaseFull]            # Inherits from multiple parents
...
1. **Names with lowercase letters**: `ent-LedLightBulb = светодиодная лампа`
2. **Descriptions with a capital letter**: `.desc = Энергоэффективная лампочка.`
