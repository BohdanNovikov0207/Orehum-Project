...
| Prototype IDs | `CamelCase` for ID | `FloorWaterEntity`, `Orehum_ActionSummonGun` | 2026-01-08 | Use |
| Fork IDs | Fork prefix for fork-only content | `OrehumAmmunition` | 2026-01-14 | Use |
